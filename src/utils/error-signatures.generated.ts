 ...
 *
 * Generated: 2026-02-26T16:12:21.613Z
 * Total errors: 165
 *
...
export const ERROR_METADATA: Record<KnownErrorSignature, ErrorMetadata> = {
  '0x6697b232': {
    ...
    inputs: [],
    source: 'AUT_Roles_v2, Governor_v1',
  },
  '0xe2517d3f': {
  ...
  '0xf92ee8a9': {
    ...
    inputs: [],
    source:
      'AUT_Roles_v2, CreditFacility_v1, FloorFactory_v1, Floor_v1, Governor_v1, ModuleFactory_v1, Presale_v1, SplitterTreasury_v1, StakingManager_v1, TestnetStrategy_v1, TransactionForwarder_v1',
  },
  '0xa972f3d2': {
