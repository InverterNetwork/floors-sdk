...
export interface Market_avg_order_by {buyFeeBps?: (order_by | null),createdAt?: (order_by | null),currentPriceRaw?: (order_by | null),floorPriceRaw?: (order_by | null),floorSegmentSupplyRaw?: (order_by | null),floorSupplyRaw?: (order_by | null),initialFloorPriceRaw?: (order_by | null),lastElevationTimestamp?: (order_by | null),lastTradeTimestamp?: (order_by | null),lastUpdatedAt?: (order_by | null),marketSupplyRaw?: (order_by | null),maxLTV?: (order_by | null),sellFeeBps?: (order_by | null),totalSupplyRaw?: (order_by | null),tradingFeeBps?: (order_by | null)}
...
export interface Market_max_order_by {buyFeeBps?: (order_by | null),createdAt?: (order_by | null),creator_id?: (order_by | null),currentPriceFormatted?: (order_by | null),currentPriceRaw?: (order_by | null),factory_id?: (order_by | null),floorPriceFormatted?: (order_by | null),floorPriceRaw?: (order_by | null),floorSegmentSupplyFormatted?: (order_by | null),floorSegmentSupplyRaw?: (order_by | null),floorSupplyFormatted?: (order_by | null),floorSupplyRaw?: (order_by | null),id?: (order_by | null),initialFloorPriceFormatted?: (order_by | null),initialFloorPriceRaw?: (order_by | null),issuanceToken_id?: (order_by | null),lastElevationTimestamp?: (order_by | null),lastTradeTimestamp?: (order_by | null),lastUpdatedAt?: (order_by | null),marketSupplyFormatted?: (order_by | null),marketSupplyRaw?: (order_by | null),maxLTV?: (order_by | null),reserveToken_id?: (order_by | null),sellFeeBps?: (order_by | null),status?: (order_by | null),totalSupplyFormatted?: (order_by | null),totalSupplyRaw?: (order_by | null),tradingFeeBps?: (order_by | null)}
