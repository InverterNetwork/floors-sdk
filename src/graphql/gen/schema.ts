...
export type AuthorizerContract_select_column =
  | 'createdAt'
  | 'floor'
  | 'id'
  | 'lastAssignedRoleId'
...
export type CreditFacilityContract_select_column =
  | 'borrowToken_id'
  | 'borrowingFeeRate'
  | 'collateralToken_id'
  | 'createdAt'
...
export type FeeSplitterPayment_select_column =
  | 'amountFormatted'
  | 'amountRaw'
  | 'id'
  | 'isFloorFee'
...
export type FeeSplitterReceipt_select_column =
  | 'amountFormatted'
  | 'amountRaw'
  | 'id'
  | 'market_id'
...
export type FloorElevation_select_column =
...
export type GlobalRegistry_select_column =
  | 'createdAt'
  | 'floorFactoryAddress'
  | 'governorAddress'
  | 'id'
...
export type GlobalStatsSnapshot_select_column =
  | 'activeMarkets'
  | 'id'
  | 'period'
...
export type GlobalStats_select_column =
  | 'activeMarkets'
  | 'id'
  | 'lastUpdatedAt'
  | 'totalLockedCollateralFormatted'
...
export type LoanStatusHistory_select_column =
  | 'id'
  | 'loan_id'
...
export type Loan_select_column =
...
export type MarketRollingStats_select_column =
...
export type MarketSnapshot_select_column =
  | 'floorPriceFormatted'
  | 'floorPriceRaw'
  | 'id'
...
export type Market_select_column =
  | 'buyFeeBps'
  | 'createdAt'
  | 'creator_id'
...
export type ModuleAddress_select_column =
  | 'createdAt'
  | 'id'
  | 'lastUpdatedAt'
  | 'market_id'
...
export type ModuleRegistry_select_column =
  | 'authorizer'
  | 'createdAt'
  | 'creditFacility'
  | 'feeTreasury'
...
export type PreSaleContract_select_column =
  | 'authorizer'
  | 'commissionBps'
  | 'createdAt'
  | 'currentState'
...
export type PresaleClaim_select_column =
  | 'amountFormatted'
  | 'amountRaw'
  | 'claimType'
  | 'id'
...
export type PresaleParticipation_select_column =
...
export type PriceCandle_select_column =
  | 'closeFormatted'
  | 'closeRaw'
  | 'highFormatted'
  | 'highRaw'
...
export type RoleMember_select_column =
  | 'grantedAt'
  | 'grantedBy'
  | 'id'
  | 'member'
...
export type RolePermission_select_column =
  | 'addedAt'
  | 'id'
  | 'role_id'
  | 'selector'
...
export type StakePosition_select_column =
...
export type StakingActivity_select_column =
  | 'activityType'
...
export type StakingManager_select_column =
  | 'createdAt'
  | 'id'
  | 'lastUpdatedAt'
  | 'market_id'
...
export type Strategy_select_column =
  | 'addedAt'
  | 'id'
  | 'isActive'
  | 'name'
...
export type Trade_select_column =
  | 'feeFormatted'
  | 'feeRaw'
  | 'id'
  | 'market_id'
...
export type Treasury_select_column =
  | 'createdAt'
  | 'id'
  | 'lastUpdatedAt'
  | 'market_id'
...
export type UserMarketPosition_select_column =
...
export interface AccountGenqlSelection {
  ...
  /** An array relationship */
  marketsCreated?: MarketGenqlSelection & {
    __args?: {
      /** distinct select on columns */
  ...
  /** An array relationship */
  presaleParticipations?: PresaleParticipationGenqlSelection & {
    __args?: {
      /** distinct select on columns */
  ...
  /** An array relationship */
  stakingPositions?: StakePositionGenqlSelection & {
    __args?: {
      /** distinct select on columns */
  ...
  /** An array relationship */
  userMarketPositions?: UserMarketPositionGenqlSelection & {
    __args?: {
      /** distinct select on columns */
...
export interface Account_bool_exp {
  _and?: Account_bool_exp[] | null
  _not?: Account_bool_exp | null
  _or?: Account_bool_exp[] | null
  id?: String_comparison_exp | null
  loans?: Loan_bool_exp | null
  marketsCreated?: Market_bool_exp | null
  presaleParticipations?: PresaleParticipation_bool_exp | null
  stakingPositions?: StakePosition_bool_exp | null
  trades?: Trade_bool_exp | null
  userMarketPositions?: UserMarketPosition_bool_exp | null
}

/** Ordering options when selecting data from "Account". */
export interface Account_order_by {
  id?: order_by | null
  loans_aggregate?: Loan_aggregate_order_by | null
  marketsCreated_aggregate?: Market_aggregate_order_by | null
  presaleParticipations_aggregate?: PresaleParticipation_aggregate_order_by | null
  stakingPositions_aggregate?: StakePosition_aggregate_order_by | null
  trades_aggregate?: Trade_aggregate_order_by | null
  userMarketPositions_aggregate?: UserMarketPosition_aggregate_order_by | null
}
...
export interface AuthorizerContract_bool_exp {
  _and?: AuthorizerContract_bool_exp[] | null
  _not?: AuthorizerContract_bool_exp | null
  _or?: AuthorizerContract_bool_exp[] | null
  createdAt?: numeric_comparison_exp | null
  floor?: String_comparison_exp | null
  id?: String_comparison_exp | null
  lastAssignedRoleId?: numeric_comparison_exp | null
...
export interface AuthorizerContract_order_by {
  createdAt?: order_by | null
  floor?: order_by | null
  id?: order_by | null
  lastAssignedRoleId?: order_by | null
  lastUpdatedAt?: order_by | null
...
/** Initial value of the column from where the streaming should start */
export interface AuthorizerContract_stream_cursor_value_input {
  createdAt?: Scalars['numeric'] | null
  floor?: Scalars['String'] | null
  id?: Scalars['String'] | null
  lastAssignedRoleId?: Scalars['numeric'] | null
  lastUpdatedAt?: Scalars['numeric'] | null
}
...
export interface CreditFacilityContract_bool_exp {
  _and?: CreditFacilityContract_bool_exp[] | null
  _not?: CreditFacilityContract_bool_exp | null
  _or?: CreditFacilityContract_bool_exp[] | null
  borrowToken_id?: String_comparison_exp | null
  borrowingFeeRate?: numeric_comparison_exp | null
  ...
  loans?: Loan_bool_exp | null
  market_id?: String_comparison_exp | null
  maxLeverage?: numeric_comparison_exp | null
  totalDebtFormatted?: String_comparison_exp | null
  totalDebtRaw?: numeric_comparison_exp | null
  totalLoans?: numeric_comparison_exp | null
  totalLockedCollateralFormatted?: String_comparison_exp | null
  totalLockedCollateralRaw?: numeric_comparison_exp | null
  totalVolumeFormatted?: String_comparison_exp | null
  totalVolumeRaw?: numeric_comparison_exp | null
}

/** Ordering options when selecting data from "CreditFacilityContract". */
export interface CreditFacilityContract_order_by {
  borrowToken_id?: order_by | null
  borrowingFeeRate?: order_by | null
  collateralToken_id?: order_by | null
  createdAt?: order_by | null
  id?: order_by | null
  lastUpdatedAt?: order_by | null
  loanToValueRatio?: order_by | null
  loans_aggregate?: Loan_aggregate_order_by | null
  market_id?: order_by | null
  maxLeverage?: order_by | null
  totalDebtFormatted?: order_by | null
  totalDebtRaw?: order_by | null
  totalLoans?: order_by | null
  totalLockedCollateralFormatted?: order_by | null
  totalLockedCollateralRaw?: order_by | null
  totalVolumeFormatted?: order_by | null
  totalVolumeRaw?: order_by | null
}
...
/** Initial value of the column from where the streaming should start */
export interface CreditFacilityContract_stream_cursor_value_input {
  borrowToken_id?: Scalars['String'] | null
  borrowingFeeRate?: Scalars['numeric'] | null
  collateralToken_id?: Scalars['String'] | null
  createdAt?: Scalars['numeric'] | null
  id?: Scalars['String'] | null
  lastUpdatedAt?: Scalars['numeric'] | null
  loanToValueRatio?: Scalars['numeric'] | null
  market_id?: Scalars['String'] | null
  maxLeverage?: Scalars['numeric'] | null
  totalDebtFormatted?: Scalars['String'] | null
  totalDebtRaw?: Scalars['numeric'] | null
  totalLoans?: Scalars['numeric'] | null
  totalLockedCollateralFormatted?: Scalars['String'] | null
  totalLockedCollateralRaw?: Scalars['numeric'] | null
  totalVolumeFormatted?: Scalars['String'] | null
  totalVolumeRaw?: Scalars['numeric'] | null
}
...
export interface FeeSplitterPayment_aggregate_order_by {
  avg?: FeeSplitterPayment_avg_order_by | null
  count?: order_by | null
  max?: FeeSplitterPayment_max_order_by | null
  min?: FeeSplitterPayment_min_order_by | null
  stddev?: FeeSplitterPayment_stddev_order_by | null
  stddev_pop?: FeeSplitterPayment_stddev_pop_order_by | null
  stddev_samp?: FeeSplitterPayment_stddev_samp_order_by | null
  sum?: FeeSplitterPayment_sum_order_by | null
  var_pop?: FeeSplitterPayment_var_pop_order_by | null
  var_samp?: FeeSplitterPayment_var_samp_order_by | null
  variance?: FeeSplitterPayment_variance_order_by | null
}

/** order by avg() on columns of table "FeeSplitterPayment" */
export interface FeeSplitterPayment_avg_order_by {
...
export interface FeeSplitterPayment_bool_exp {
  _and?: FeeSplitterPayment_bool_exp[] | null
  _not?: FeeSplitterPayment_bool_exp | null
  _or?: FeeSplitterPayment_bool_exp[] | null
  amountFormatted?: String_comparison_exp | null
  amountRaw?: numeric_comparison_exp | null
  id?: String_comparison_exp | null
  isFloorFee?: Boolean_comparison_exp | null
  market_id?: String_comparison_exp | null
...
export interface FeeSplitterPayment_min_order_by {
  amountFormatted?: order_by | null
  amountRaw?: order_by | null
  id?: order_by | null
  market_id?: order_by | null
...
export interface FeeSplitterPayment_order_by {
  amountFormatted?: order_by | null
  amountRaw?: order_by | null
  id?: order_by | null
  isFloorFee?: order_by | null
  market_id?: order_by | null
  recipient?: order_by | null
  timestamp?: order_by | null
  token_id?: order_by | null
...
export interface FeeSplitterPayment_stddev_order_by {
  amountRaw?: order_by | null
  timestamp?: order_by | null
}

/** order by stddev_pop() on columns of table "FeeSplitterPayment" */
export interface FeeSplitterPayment_stddev_pop_order_by {
  amountRaw?: order_by | null
  timestamp?: order_by | null
}

/** order by stddev_samp() on columns of table "FeeSplitterPayment" */
export interface FeeSplitterPayment_stddev_samp_order_by {
  amountRaw?: order_by | null
  timestamp?: order_by | null
}
...
/** Initial value of the column from where the streaming should start */
export interface FeeSplitterPayment_stream_cursor_value_input {
  amountFormatted?: Scalars['String'] | null
  amountRaw?: Scalars['numeric'] | null
  id?: Scalars['String'] | null
  isFloorFee?: Scalars['Boolean'] | null
  market_id?: Scalars['String'] | null
  recipient?: Scalars['String'] | null
  timestamp?: Scalars['numeric'] | null
...
export interface FeeSplitterPayment_sum_order_by {
  amountRaw?: order_by | null
  timestamp?: order_by | null
}

/** order by var_pop() on columns of table "FeeSplitterPayment" */
export interface FeeSplitterPayment_var_pop_order_by {
  amountRaw?: order_by | null
  timestamp?: order_by | null
}

/** order by var_samp() on columns of table "FeeSplitterPayment" */
export interface FeeSplitterPayment_var_samp_order_by {
  amountRaw?: order_by | null
  timestamp?: order_by | null
}

/** order by variance() on columns of table "FeeSplitterPayment" */
export interface FeeSplitterPayment_variance_order_by {
  amountRaw?: order_by | null
  timestamp?: order_by | null
}
...
export interface FeeSplitterReceipt_aggregate_order_by {
  avg?: FeeSplitterReceipt_avg_order_by | null
  count?: order_by | null
  max?: FeeSplitterReceipt_max_order_by | null
  min?: FeeSplitterReceipt_min_order_by | null
  stddev?: FeeSplitterReceipt_stddev_order_by | null
  stddev_pop?: FeeSplitterReceipt_stddev_pop_order_by | null
  stddev_samp?: FeeSplitterReceipt_stddev_samp_order_by | null
  sum?: FeeSplitterReceipt_sum_order_by | null
  var_pop?: FeeSplitterReceipt_var_pop_order_by | null
  var_samp?: FeeSplitterReceipt_var_samp_order_by | null
  variance?: FeeSplitterReceipt_variance_order_by | null
}

/** order by avg() on columns of table "FeeSplitterReceipt" */
export interface FeeSplitterReceipt_avg_order_by {
  amountRaw?: order_by | null
  timestamp?: order_by | null
}

/** Boolean expression to filter rows from the table "FeeSplitterReceipt". All fields are combined with a logical 'AND'. */
export interface FeeSplitterReceipt_bool_exp {
  _and?: FeeSplitterReceipt_bool_exp[] | null
  _not?: FeeSplitterReceipt_bool_exp | null
  _or?: FeeSplitterReceipt_bool_exp[] | null
  amountFormatted?: String_comparison_exp | null
  amountRaw?: numeric_comparison_exp | null
  id?: String_comparison_exp | null
  market_id?: String_comparison_exp | null
...
export interface FeeSplitterReceipt_max_order_by {
  amountFormatted?: order_by | null
  amountRaw?: order_by | null
  id?: order_by | null
  market_id?: order_by | null
  sender?: order_by | null
  timestamp?: order_by | null
  token_id?: order_by | null
  transactionHash?: order_by | null
  treasury_id?: order_by | null
...
export interface FeeSplitterReceipt_min_order_by {
  amountFormatted?: order_by | null
  amountRaw?: order_by | null
  id?: order_by | null
  market_id?: order_by | null
...
export interface FeeSplitterReceipt_order_by {
  amountFormatted?: order_by | null
  amountRaw?: order_by | null
  id?: order_by | null
  market_id?: order_by | null
...
export interface FeeSplitterReceipt_stddev_order_by {
  amountRaw?: order_by | null
  timestamp?: order_by | null
}

/** order by stddev_pop() on columns of table "FeeSplitterReceipt" */
export interface FeeSplitterReceipt_stddev_pop_order_by {
  amountRaw?: order_by | null
  timestamp?: order_by | null
}

/** order by stddev_samp() on columns of table "FeeSplitterReceipt" */
export interface FeeSplitterReceipt_stddev_samp_order_by {
  amountRaw?: order_by | null
  timestamp?: order_by | null
}
...
/** Initial value of the column from where the streaming should start */
export interface FeeSplitterReceipt_stream_cursor_value_input {
  amountFormatted?: Scalars['String'] | null
  amountRaw?: Scalars['numeric'] | null
  id?: Scalars['String'] | null
  market_id?: Scalars['String'] | null
...
export interface FeeSplitterReceipt_sum_order_by {
  amountRaw?: order_by | null
  timestamp?: order_by | null
}

/** order by var_pop() on columns of table "FeeSplitterReceipt" */
export interface FeeSplitterReceipt_var_pop_order_by {
  amountRaw?: order_by | null
  timestamp?: order_by | null
}

/** order by var_samp() on columns of table "FeeSplitterReceipt" */
export interface FeeSplitterReceipt_var_samp_order_by {
  amountRaw?: order_by | null
  timestamp?: order_by | null
}

/** order by variance() on columns of table "FeeSplitterReceipt" */
export interface FeeSplitterReceipt_variance_order_by {
  amountRaw?: order_by | null
  timestamp?: order_by | null
}
...
export interface FloorElevation_aggregate_order_by {
  avg?: FloorElevation_avg_order_by | null
  count?: order_by | null
  max?: FloorElevation_max_order_by | null
  min?: FloorElevation_min_order_by | null
  stddev?: FloorElevation_stddev_order_by | null
  stddev_pop?: FloorElevation_stddev_pop_order_by | null
  stddev_samp?: FloorElevation_stddev_samp_order_by | null
  sum?: FloorElevation_sum_order_by | null
  var_pop?: FloorElevation_var_pop_order_by | null
  var_samp?: FloorElevation_var_samp_order_by | null
  variance?: FloorElevation_variance_order_by | null
}

/** order by avg() on columns of table "FloorElevation" */
export interface FloorElevation_avg_order_by {
  deployedAmountRaw?: order_by | null
  newFloorPriceRaw?: order_by | null
  oldFloorPriceRaw?: order_by | null
  timestamp?: order_by | null
}

/** Boolean expression to filter rows from the table "FloorElevation". All fields are combined with a logical 'AND'. */
export interface FloorElevation_bool_exp {
  _and?: FloorElevation_bool_exp[] | null
  _not?: FloorElevation_bool_exp | null
  _or?: FloorElevation_bool_exp[] | null
  deployedAmountFormatted?: String_comparison_exp | null
  deployedAmountRaw?: numeric_comparison_exp | null
  id?: String_comparison_exp | null
  market_id?: String_comparison_exp | null
  newFloorPriceFormatted?: String_comparison_exp | null
  newFloorPriceRaw?: numeric_comparison_exp | null
  oldFloorPriceFormatted?: String_comparison_exp | null
  oldFloorPriceRaw?: numeric_comparison_exp | null
  timestamp?: numeric_comparison_exp | null
  transactionHash?: String_comparison_exp | null
}

/** order by max() on columns of table "FloorElevation" */
export interface FloorElevation_max_order_by {
  deployedAmountFormatted?: order_by | null
  deployedAmountRaw?: order_by | null
  id?: order_by | null
  market_id?: order_by | null
  newFloorPriceFormatted?: order_by | null
  newFloorPriceRaw?: order_by | null
  oldFloorPriceFormatted?: order_by | null
  oldFloorPriceRaw?: order_by | null
  timestamp?: order_by | null
  transactionHash?: order_by | null
}
...
export interface FloorElevation_min_order_by {
  deployedAmountFormatted?: order_by | null
  deployedAmountRaw?: order_by | null
  id?: order_by | null
  market_id?: order_by | null
...
export interface FloorElevation_stddev_order_by {
  deployedAmountRaw?: order_by | null
  newFloorPriceRaw?: order_by | null
  oldFloorPriceRaw?: order_by | null
  timestamp?: order_by | null
...
export interface FloorElevation_stddev_pop_order_by {
  deployedAmountRaw?: order_by | null
  newFloorPriceRaw?: order_by | null
  oldFloorPriceRaw?: order_by | null
  timestamp?: order_by | null
...
export interface FloorElevation_stddev_samp_order_by {
  deployedAmountRaw?: order_by | null
  newFloorPriceRaw?: order_by | null
  oldFloorPriceRaw?: order_by | null
  timestamp?: order_by | null
...
/** Initial value of the column from where the streaming should start */
export interface FloorElevation_stream_cursor_value_input {
  deployedAmountFormatted?: Scalars['String'] | null
  deployedAmountRaw?: Scalars['numeric'] | null
  id?: Scalars['String'] | null
  market_id?: Scalars['String'] | null
  newFloorPriceFormatted?: Scalars['String'] | null
  newFloorPriceRaw?: Scalars['numeric'] | null
  oldFloorPriceFormatted?: Scalars['String'] | null
  oldFloorPriceRaw?: Scalars['numeric'] | null
  timestamp?: Scalars['numeric'] | null
  transactionHash?: Scalars['String'] | null
}

/** order by sum() on columns of table "FloorElevation" */
export interface FloorElevation_sum_order_by {
  deployedAmountRaw?: order_by | null
  newFloorPriceRaw?: order_by | null
  oldFloorPriceRaw?: order_by | null
  timestamp?: order_by | null
...
export interface FloorElevation_var_pop_order_by {
  deployedAmountRaw?: order_by | null
  newFloorPriceRaw?: order_by | null
  oldFloorPriceRaw?: order_by | null
  timestamp?: order_by | null
...
export interface FloorElevation_var_samp_order_by {
  deployedAmountRaw?: order_by | null
  newFloorPriceRaw?: order_by | null
  oldFloorPriceRaw?: order_by | null
  timestamp?: order_by | null
...
export interface FloorElevation_variance_order_by {
  deployedAmountRaw?: order_by | null
  newFloorPriceRaw?: order_by | null
  oldFloorPriceRaw?: order_by | null
  timestamp?: order_by | null
...
export interface GlobalRegistry_bool_exp {
  _and?: GlobalRegistry_bool_exp[] | null
  _not?: GlobalRegistry_bool_exp | null
  _or?: GlobalRegistry_bool_exp[] | null
  createdAt?: numeric_comparison_exp | null
  floorFactoryAddress?: String_comparison_exp | null
  governorAddress?: String_comparison_exp | null
  id?: String_comparison_exp | null
  lastUpdatedAt?: numeric_comparison_exp | null
  moduleFactoryAddress?: String_comparison_exp | null
  registeredStrategies?: String_array_comparison_exp | null
  trustedForwarderAddress?: String_comparison_exp | null
}

/** Ordering options when selecting data from "GlobalRegistry". */
export interface GlobalRegistry_order_by {
  createdAt?: order_by | null
  floorFactoryAddress?: order_by | null
  governorAddress?: order_by | null
  id?: order_by | null
  lastUpdatedAt?: order_by | null
  moduleFactoryAddress?: order_by | null
  registeredStrategies?: order_by | null
  trustedForwarderAddress?: order_by | null
}
...
/** Initial value of the column from where the streaming should start */
export interface GlobalRegistry_stream_cursor_value_input {
  createdAt?: Scalars['numeric'] | null
  floorFactoryAddress?: Scalars['String'] | null
  governorAddress?: Scalars['String'] | null
  id?: Scalars['String'] | null
  lastUpdatedAt?: Scalars['numeric'] | null
  moduleFactoryAddress?: Scalars['String'] | null
  registeredStrategies?: Scalars['String'][] | null
  trustedForwarderAddress?: Scalars['String'] | null
}
...
export interface GlobalStatsSnapshot_bool_exp {
  _and?: GlobalStatsSnapshot_bool_exp[] | null
  _not?: GlobalStatsSnapshot_bool_exp | null
  _or?: GlobalStatsSnapshot_bool_exp[] | null
  activeMarkets?: numeric_comparison_exp | null
  id?: String_comparison_exp | null
  period?: snapshotperiod_comparison_exp | null
  periodVolumeFormatted?: String_comparison_exp | null
  periodVolumeRaw?: numeric_comparison_exp | null
  timestamp?: numeric_comparison_exp | null
  totalMarketCapFormatted?: String_comparison_exp | null
  totalMarketCapRaw?: numeric_comparison_exp | null
  totalMarkets?: numeric_comparison_exp | null
  totalValueLockedFormatted?: String_comparison_exp | null
  totalValueLockedRaw?: numeric_comparison_exp | null
}

/** Ordering options when selecting data from "GlobalStatsSnapshot". */
export interface GlobalStatsSnapshot_order_by {
  activeMarkets?: order_by | null
  id?: order_by | null
  period?: order_by | null
  periodVolumeFormatted?: order_by | null
  periodVolumeRaw?: order_by | null
  timestamp?: order_by | null
  totalMarketCapFormatted?: order_by | null
  totalMarketCapRaw?: order_by | null
  totalMarkets?: order_by | null
  totalValueLockedFormatted?: order_by | null
  totalValueLockedRaw?: order_by | null
}
...
/** Initial value of the column from where the streaming should start */
export interface GlobalStatsSnapshot_stream_cursor_value_input {
  activeMarkets?: Scalars['numeric'] | null
  id?: Scalars['String'] | null
  period?: Scalars['snapshotperiod'] | null
  periodVolumeFormatted?: Scalars['String'] | null
  periodVolumeRaw?: Scalars['numeric'] | null
  timestamp?: Scalars['numeric'] | null
  totalMarketCapFormatted?: Scalars['String'] | null
  totalMarketCapRaw?: Scalars['numeric'] | null
  totalMarkets?: Scalars['numeric'] | null
  totalValueLockedFormatted?: Scalars['String'] | null
  totalValueLockedRaw?: Scalars['numeric'] | null
}

/** Boolean expression to filter rows from the table "GlobalStats". All fields are combined with a logical 'AND'. */
export interface GlobalStats_bool_exp {
  _and?: GlobalStats_bool_exp[] | null
  _not?: GlobalStats_bool_exp | null
  _or?: GlobalStats_bool_exp[] | null
  activeMarkets?: numeric_comparison_exp | null
  id?: String_comparison_exp | null
  lastUpdatedAt?: numeric_comparison_exp | null
  totalLockedCollateralFormatted?: String_comparison_exp | null
  totalLockedCollateralRaw?: numeric_comparison_exp | null
  totalMarkets?: numeric_comparison_exp | null
  totalOutstandingDebtFormatted?: String_comparison_exp | null
  totalOutstandingDebtRaw?: numeric_comparison_exp | null
  totalVolumeFormatted?: String_comparison_exp | null
  totalVolumeRaw?: numeric_comparison_exp | null
}

/** Ordering options when selecting data from "GlobalStats". */
export interface GlobalStats_order_by {
  activeMarkets?: order_by | null
  id?: order_by | null
  lastUpdatedAt?: order_by | null
  totalLockedCollateralFormatted?: order_by | null
  totalLockedCollateralRaw?: order_by | null
  totalMarkets?: order_by | null
  totalOutstandingDebtFormatted?: order_by | null
  totalOutstandingDebtRaw?: order_by | null
  totalVolumeFormatted?: order_by | null
  totalVolumeRaw?: order_by | null
}
...
/** Initial value of the column from where the streaming should start */
export interface GlobalStats_stream_cursor_value_input {
  activeMarkets?: Scalars['numeric'] | null
  id?: Scalars['String'] | null
  lastUpdatedAt?: Scalars['numeric'] | null
  totalLockedCollateralFormatted?: Scalars['String'] | null
  totalLockedCollateralRaw?: Scalars['numeric'] | null
  totalMarkets?: Scalars['numeric'] | null
  totalOutstandingDebtFormatted?: Scalars['String'] | null
  totalOutstandingDebtRaw?: Scalars['numeric'] | null
  totalVolumeFormatted?: Scalars['String'] | null
  totalVolumeRaw?: Scalars['numeric'] | null
}
...
export interface LoanGenqlSelection {
  ...
  /** An array relationship */
  statusHistory?: LoanStatusHistoryGenqlSelection & {
    __args?: {
      /** distinct select on columns */
...
export interface LoanStatusHistory_aggregate_order_by {
  avg?: LoanStatusHistory_avg_order_by | null
  count?: order_by | null
  max?: LoanStatusHistory_max_order_by | null
  min?: LoanStatusHistory_min_order_by | null
  stddev?: LoanStatusHistory_stddev_order_by | null
  stddev_pop?: LoanStatusHistory_stddev_pop_order_by | null
  stddev_samp?: LoanStatusHistory_stddev_samp_order_by | null
  sum?: LoanStatusHistory_sum_order_by | null
  var_pop?: LoanStatusHistory_var_pop_order_by | null
  var_samp?: LoanStatusHistory_var_samp_order_by | null
  variance?: LoanStatusHistory_variance_order_by | null
}

/** order by avg() on columns of table "LoanStatusHistory" */
export interface LoanStatusHistory_avg_order_by {
  lockedCollateralRaw?: order_by | null
  remainingDebtRaw?: order_by | null
  timestamp?: order_by | null
}

/** Boolean expression to filter rows from the table "LoanStatusHistory". All fields are combined with a logical 'AND'. */
export interface LoanStatusHistory_bool_exp {
  _and?: LoanStatusHistory_bool_exp[] | null
  _not?: LoanStatusHistory_bool_exp | null
  _or?: LoanStatusHistory_bool_exp[] | null
  id?: String_comparison_exp | null
  loan_id?: String_comparison_exp | null
  lockedCollateralFormatted?: String_comparison_exp | null
  lockedCollateralRaw?: numeric_comparison_exp | null
  remainingDebtFormatted?: String_comparison_exp | null
  remainingDebtRaw?: numeric_comparison_exp | null
  status?: loanstatus_comparison_exp | null
  timestamp?: numeric_comparison_exp | null
  transactionHash?: String_comparison_exp | null
}

/** order by max() on columns of table "LoanStatusHistory" */
export interface LoanStatusHistory_max_order_by {
  id?: order_by | null
  loan_id?: order_by | null
  lockedCollateralFormatted?: order_by | null
  lockedCollateralRaw?: order_by | null
  remainingDebtFormatted?: order_by | null
  remainingDebtRaw?: order_by | null
...
export interface LoanStatusHistory_min_order_by {
  id?: order_by | null
  loan_id?: order_by | null
  lockedCollateralFormatted?: order_by | null
  lockedCollateralRaw?: order_by | null
...
export interface LoanStatusHistory_order_by {
  id?: order_by | null
  loan_id?: order_by | null
  lockedCollateralFormatted?: order_by | null
  lockedCollateralRaw?: order_by | null
...
export interface LoanStatusHistory_stddev_order_by {
  lockedCollateralRaw?: order_by | null
  remainingDebtRaw?: order_by | null
  timestamp?: order_by | null
}
...
export interface LoanStatusHistory_stddev_pop_order_by {
  lockedCollateralRaw?: order_by | null
  remainingDebtRaw?: order_by | null
  timestamp?: order_by | null
}
...
export interface LoanStatusHistory_stddev_samp_order_by {
  lockedCollateralRaw?: order_by | null
  remainingDebtRaw?: order_by | null
  timestamp?: order_by | null
}
...
export interface LoanStatusHistory_stream_cursor_value_input {
  id?: Scalars['String'] | null
  loan_id?: Scalars['String'] | null
  lockedCollateralFormatted?: Scalars['String'] | null
  lockedCollateralRaw?: Scalars['numeric'] | null
  remainingDebtFormatted?: Scalars['String'] | null
  remainingDebtRaw?: Scalars['numeric'] | null
  status?: Scalars['loanstatus'] | null
  timestamp?: Scalars['numeric'] | null
  transactionHash?: Scalars['String'] | null
}

/** order by sum() on columns of table "LoanStatusHistory" */
export interface LoanStatusHistory_sum_order_by {
  lockedCollateralRaw?: order_by | null
  remainingDebtRaw?: order_by | null
  timestamp?: order_by | null
}
...
export interface LoanStatusHistory_var_pop_order_by {
  lockedCollateralRaw?: order_by | null
  remainingDebtRaw?: order_by | null
  timestamp?: order_by | null
}
...
export interface LoanStatusHistory_var_samp_order_by {
  lockedCollateralRaw?: order_by | null
  remainingDebtRaw?: order_by | null
  timestamp?: order_by | null
}
...
export interface LoanStatusHistory_variance_order_by {
  lockedCollateralRaw?: order_by | null
  remainingDebtRaw?: order_by | null
  timestamp?: order_by | null
}
...
export interface Loan_aggregate_order_by {
  avg?: Loan_avg_order_by | null
  count?: order_by | null
  max?: Loan_max_order_by | null
  min?: Loan_min_order_by | null
  stddev?: Loan_stddev_order_by | null
  stddev_pop?: Loan_stddev_pop_order_by | null
  stddev_samp?: Loan_stddev_samp_order_by | null
  sum?: Loan_sum_order_by | null
  var_pop?: Loan_var_pop_order_by | null
  var_samp?: Loan_var_samp_order_by | null
  variance?: Loan_variance_order_by | null
}

/** order by avg() on columns of table "Loan" */
export interface Loan_avg_order_by {
  borrowAmountRaw?: order_by | null
  closedAt?: order_by | null
  floorPriceAtBorrowRaw?: order_by | null
  lastUpdatedAt?: order_by | null
  lockedCollateralRaw?: order_by | null
  openedAt?: order_by | null
  originationFeeRaw?: order_by | null
  remainingDebtRaw?: order_by | null
}

/** Boolean expression to filter rows from the table "Loan". All fields are combined with a logical 'AND'. */
export interface Loan_bool_exp {
  _and?: Loan_bool_exp[] | null
  _not?: Loan_bool_exp | null
  _or?: Loan_bool_exp[] | null
  borrowAmountFormatted?: String_comparison_exp | null
  borrowAmountRaw?: numeric_comparison_exp | null
  borrower_id?: String_comparison_exp | null
  closedAt?: numeric_comparison_exp | null
  facility_id?: String_comparison_exp | null
  floorPriceAtBorrowFormatted?: String_comparison_exp | null
  floorPriceAtBorrowRaw?: numeric_comparison_exp | null
  id?: String_comparison_exp | null
  lastUpdatedAt?: numeric_comparison_exp | null
  lockedCollateralFormatted?: String_comparison_exp | null
  lockedCollateralRaw?: numeric_comparison_exp | null
  market_id?: String_comparison_exp | null
  openedAt?: numeric_comparison_exp | null
  originationFeeFormatted?: String_comparison_exp | null
  originationFeeRaw?: numeric_comparison_exp | null
  remainingDebtFormatted?: String_comparison_exp | null
  remainingDebtRaw?: numeric_comparison_exp | null
  status?: loanstatus_comparison_exp | null
  statusHistory?: LoanStatusHistory_bool_exp | null
  transactionHash?: String_comparison_exp | null
}

/** order by max() on columns of table "Loan" */
export interface Loan_max_order_by {
  borrowAmountFormatted?: order_by | null
  borrowAmountRaw?: order_by | null
  borrower_id?: order_by | null
  closedAt?: order_by | null
  facility_id?: order_by | null
  floorPriceAtBorrowFormatted?: order_by | null
  floorPriceAtBorrowRaw?: order_by | null
  id?: order_by | null
  lastUpdatedAt?: order_by | null
  lockedCollateralFormatted?: order_by | null
  ...
  market_id?: order_by | null
  openedAt?: order_by | null
  originationFeeFormatted?: order_by | null
  originationFeeRaw?: order_by | null
  remainingDebtFormatted?: order_by | null
  remainingDebtRaw?: order_by | null
  status?: order_by | null
...
export interface Loan_min_order_by {
  borrowAmountFormatted?: order_by | null
  borrowAmountRaw?: order_by | null
  borrower_id?: order_by | null
  closedAt?: order_by | null
...
export interface Loan_order_by {
  borrowAmountFormatted?: order_by | null
  borrowAmountRaw?: order_by | null
  borrower_id?: order_by | null
  closedAt?: order_by | null
  ...
  remainingDebtRaw?: order_by | null
  status?: order_by | null
  statusHistory_aggregate?: LoanStatusHistory_aggregate_order_by | null
  transactionHash?: order_by | null
}

/** order by stddev() on columns of table "Loan" */
export interface Loan_stddev_order_by {
  borrowAmountRaw?: order_by | null
  closedAt?: order_by | null
  floorPriceAtBorrowRaw?: order_by | null
  lastUpdatedAt?: order_by | null
...
export interface Loan_stddev_pop_order_by {
  borrowAmountRaw?: order_by | null
  closedAt?: order_by | null
  floorPriceAtBorrowRaw?: order_by | null
  lastUpdatedAt?: order_by | null
...
export interface Loan_stddev_samp_order_by {
  borrowAmountRaw?: order_by | null
  closedAt?: order_by | null
  floorPriceAtBorrowRaw?: order_by | null
  lastUpdatedAt?: order_by | null
...
/** Initial value of the column from where the streaming should start */
export interface Loan_stream_cursor_value_input {
  borrowAmountFormatted?: Scalars['String'] | null
  borrowAmountRaw?: Scalars['numeric'] | null
  borrower_id?: Scalars['String'] | null
  closedAt?: Scalars['numeric'] | null
  facility_id?: Scalars['String'] | null
  floorPriceAtBorrowFormatted?: Scalars['String'] | null
  floorPriceAtBorrowRaw?: Scalars['numeric'] | null
  id?: Scalars['String'] | null
  lastUpdatedAt?: Scalars['numeric'] | null
  lockedCollateralFormatted?: Scalars['String'] | null
  lockedCollateralRaw?: Scalars['numeric'] | null
  market_id?: Scalars['String'] | null
  openedAt?: Scalars['numeric'] | null
  originationFeeFormatted?: Scalars['String'] | null
  originationFeeRaw?: Scalars['numeric'] | null
  remainingDebtFormatted?: Scalars['String'] | null
  remainingDebtRaw?: Scalars['numeric'] | null
  status?: Scalars['loanstatus'] | null
  transactionHash?: Scalars['String'] | null
...
export interface Loan_sum_order_by {
  borrowAmountRaw?: order_by | null
  closedAt?: order_by | null
  floorPriceAtBorrowRaw?: order_by | null
  lastUpdatedAt?: order_by | null
...
export interface Loan_var_pop_order_by {
  borrowAmountRaw?: order_by | null
  closedAt?: order_by | null
  floorPriceAtBorrowRaw?: order_by | null
  lastUpdatedAt?: order_by | null
...
export interface Loan_var_samp_order_by {
  borrowAmountRaw?: order_by | null
  closedAt?: order_by | null
  floorPriceAtBorrowRaw?: order_by | null
  lastUpdatedAt?: order_by | null
...
export interface Loan_variance_order_by {
  borrowAmountRaw?: order_by | null
  closedAt?: order_by | null
  floorPriceAtBorrowRaw?: order_by | null
  lastUpdatedAt?: order_by | null
...
export interface MarketGenqlSelection {
  ...
  /** An array relationship */
  floorElevations?: FloorElevationGenqlSelection & {
    __args?: {
      /** distinct select on columns */
...
export interface MarketRollingStats_bool_exp {
  _and?: MarketRollingStats_bool_exp[] | null
  _not?: MarketRollingStats_bool_exp | null
  _or?: MarketRollingStats_bool_exp[] | null
  averagePriceFormatted?: String_comparison_exp | null
  averagePriceRaw?: numeric_comparison_exp | null
  id?: String_comparison_exp | null
  lastUpdatedAt?: numeric_comparison_exp | null
  market_id?: String_comparison_exp | null
  tradeCount?: numeric_comparison_exp | null
  volumeFormatted?: String_comparison_exp | null
  volumeRaw?: numeric_comparison_exp | null
  windowSeconds?: Int_comparison_exp | null
}

/** Ordering options when selecting data from "MarketRollingStats". */
export interface MarketRollingStats_order_by {
  averagePriceFormatted?: order_by | null
  averagePriceRaw?: order_by | null
  id?: order_by | null
  lastUpdatedAt?: order_by | null
  market_id?: order_by | null
  tradeCount?: order_by | null
  volumeFormatted?: order_by | null
  volumeRaw?: order_by | null
  windowSeconds?: order_by | null
}
...
export interface MarketRollingStats_stream_cursor_value_input {
  averagePriceFormatted?: Scalars['String'] | null
  averagePriceRaw?: Scalars['numeric'] | null
  id?: Scalars['String'] | null
  lastUpdatedAt?: Scalars['numeric'] | null
  market_id?: Scalars['String'] | null
  tradeCount?: Scalars['numeric'] | null
  volumeFormatted?: Scalars['String'] | null
  volumeRaw?: Scalars['numeric'] | null
  windowSeconds?: Scalars['Int'] | null
}
...
export interface MarketSnapshot_bool_exp {
  _and?: MarketSnapshot_bool_exp[] | null
  _not?: MarketSnapshot_bool_exp | null
  _or?: MarketSnapshot_bool_exp[] | null
  floorPriceFormatted?: String_comparison_exp | null
  floorPriceRaw?: numeric_comparison_exp | null
  id?: String_comparison_exp | null
  marketSupplyFormatted?: String_comparison_exp | null
  marketSupplyRaw?: numeric_comparison_exp | null
  market_id?: String_comparison_exp | null
  priceFormatted?: String_comparison_exp | null
  priceRaw?: numeric_comparison_exp | null
  timestamp?: numeric_comparison_exp | null
  totalSupplyFormatted?: String_comparison_exp | null
  totalSupplyRaw?: numeric_comparison_exp | null
  trades24h?: numeric_comparison_exp | null
  volume24hFormatted?: String_comparison_exp | null
  volume24hRaw?: numeric_comparison_exp | null
}

/** Ordering options when selecting data from "MarketSnapshot". */
export interface MarketSnapshot_order_by {
  floorPriceFormatted?: order_by | null
  floorPriceRaw?: order_by | null
  id?: order_by | null
  marketSupplyFormatted?: order_by | null
  marketSupplyRaw?: order_by | null
  market_id?: order_by | null
  priceFormatted?: order_by | null
  priceRaw?: order_by | null
  timestamp?: order_by | null
  totalSupplyFormatted?: order_by | null
  totalSupplyRaw?: order_by | null
  trades24h?: order_by | null
  volume24hFormatted?: order_by | null
  volume24hRaw?: order_by | null
}
...
/** Initial value of the column from where the streaming should start */
export interface MarketSnapshot_stream_cursor_value_input {
  floorPriceFormatted?: Scalars['String'] | null
  floorPriceRaw?: Scalars['numeric'] | null
  id?: Scalars['String'] | null
  marketSupplyFormatted?: Scalars['String'] | null
  marketSupplyRaw?: Scalars['numeric'] | null
  market_id?: Scalars['String'] | null
  priceFormatted?: Scalars['String'] | null
  priceRaw?: Scalars['numeric'] | null
  timestamp?: Scalars['numeric'] | null
  totalSupplyFormatted?: Scalars['String'] | null
  totalSupplyRaw?: Scalars['numeric'] | null
  trades24h?: Scalars['numeric'] | null
  volume24hFormatted?: Scalars['String'] | null
  volume24hRaw?: Scalars['numeric'] | null
}

/** order by aggregate values of table "Market" */
export interface Market_aggregate_order_by {
  avg?: Market_avg_order_by | null
  count?: order_by | null
  max?: Market_max_order_by | null
  min?: Market_min_order_by | null
  stddev?: Market_stddev_order_by | null
  stddev_pop?: Market_stddev_pop_order_by | null
  stddev_samp?: Market_stddev_samp_order_by | null
  sum?: Market_sum_order_by | null
  var_pop?: Market_var_pop_order_by | null
  var_samp?: Market_var_samp_order_by | null
  variance?: Market_variance_order_by | null
}

/** order by avg() on columns of table "Market" */
export interface Market_avg_order_by {
  buyFeeBps?: order_by | null
  createdAt?: order_by | null
  currentPriceRaw?: order_by | null
  floorPriceRaw?: order_by | null
  floorSupplyRaw?: order_by | null
  initialFloorPriceRaw?: order_by | null
  lastElevationTimestamp?: order_by | null
  lastTradeTimestamp?: order_by | null
  lastUpdatedAt?: order_by | null
  marketSupplyRaw?: order_by | null
  maxLTV?: order_by | null
  sellFeeBps?: order_by | null
  totalSupplyRaw?: order_by | null
  tradingFeeBps?: order_by | null
}

/** Boolean expression to filter rows from the table "Market". All fields are combined with a logical 'AND'. */
export interface Market_bool_exp {
  _and?: Market_bool_exp[] | null
  _not?: Market_bool_exp | null
  _or?: Market_bool_exp[] | null
  buyFeeBps?: numeric_comparison_exp | null
  createdAt?: numeric_comparison_exp | null
  creator_id?: String_comparison_exp | null
  currentPriceFormatted?: String_comparison_exp | null
  currentPriceRaw?: numeric_comparison_exp | null
  factory_id?: String_comparison_exp | null
  floorElevations?: FloorElevation_bool_exp | null
  floorPriceFormatted?: String_comparison_exp | null
  floorPriceRaw?: numeric_comparison_exp | null
  floorSupplyFormatted?: String_comparison_exp | null
  floorSupplyRaw?: numeric_comparison_exp | null
  id?: String_comparison_exp | null
  initialFloorPriceFormatted?: String_comparison_exp | null
  initialFloorPriceRaw?: numeric_comparison_exp | null
  isBuyOpen?: Boolean_comparison_exp | null
  isSellOpen?: Boolean_comparison_exp | null
  issuanceToken?: Token_bool_exp | null
  issuanceToken_id?: String_comparison_exp | null
  lastElevationTimestamp?: numeric_comparison_exp | null
  lastTradeTimestamp?: numeric_comparison_exp | null
  lastUpdatedAt?: numeric_comparison_exp | null
  marketSupplyFormatted?: String_comparison_exp | null
  marketSupplyRaw?: numeric_comparison_exp | null
  maxLTV?: numeric_comparison_exp | null
  reserveToken?: Token_bool_exp | null
  reserveToken_id?: String_comparison_exp | null
  sellFeeBps?: numeric_comparison_exp | null
  status?: marketstatus_comparison_exp | null
  totalSupplyFormatted?: String_comparison_exp | null
  totalSupplyRaw?: numeric_comparison_exp | null
  trades?: Trade_bool_exp | null
  tradingFeeBps?: numeric_comparison_exp | null
}

/** order by max() on columns of table "Market" */
export interface Market_max_order_by {
  buyFeeBps?: order_by | null
  createdAt?: order_by | null
  creator_id?: order_by | null
  currentPriceFormatted?: order_by | null
  currentPriceRaw?: order_by | null
  factory_id?: order_by | null
  floorPriceFormatted?: order_by | null
  floorPriceRaw?: order_by | null
  floorSupplyFormatted?: order_by | null
  floorSupplyRaw?: order_by | null
  id?: order_by | null
  initialFloorPriceFormatted?: order_by | null
  initialFloorPriceRaw?: order_by | null
...
export interface Market_min_order_by {
  buyFeeBps?: order_by | null
  createdAt?: order_by | null
  creator_id?: order_by | null
  currentPriceFormatted?: order_by | null
...
export interface Market_order_by {
  buyFeeBps?: order_by | null
  createdAt?: order_by | null
  creator_id?: order_by | null
  currentPriceFormatted?: order_by | null
  currentPriceRaw?: order_by | null
  factory_id?: order_by | null
  floorElevations_aggregate?: FloorElevation_aggregate_order_by | null
  floorPriceFormatted?: order_by | null
  floorPriceRaw?: order_by | null
  floorSupplyFormatted?: order_by | null
  floorSupplyRaw?: order_by | null
  ...
  initialFloorPriceFormatted?: order_by | null
  initialFloorPriceRaw?: order_by | null
  isBuyOpen?: order_by | null
  isSellOpen?: order_by | null
  ...
  marketSupplyRaw?: order_by | null
  maxLTV?: order_by | null
  reserveToken?: Token_order_by | null
  reserveToken_id?: order_by | null
  sellFeeBps?: order_by | null
  status?: order_by | null
  totalSupplyFormatted?: order_by | null
...
export interface Market_stddev_order_by {
  buyFeeBps?: order_by | null
  createdAt?: order_by | null
  currentPriceRaw?: order_by | null
  floorPriceRaw?: order_by | null
...
export interface Market_stddev_pop_order_by {
  buyFeeBps?: order_by | null
  createdAt?: order_by | null
  currentPriceRaw?: order_by | null
  floorPriceRaw?: order_by | null
...
export interface Market_stddev_samp_order_by {
  buyFeeBps?: order_by | null
  createdAt?: order_by | null
  currentPriceRaw?: order_by | null
  floorPriceRaw?: order_by | null
...
/** Initial value of the column from where the streaming should start */
export interface Market_stream_cursor_value_input {
  buyFeeBps?: Scalars['numeric'] | null
  createdAt?: Scalars['numeric'] | null
  creator_id?: Scalars['String'] | null
  currentPriceFormatted?: Scalars['String'] | null
  currentPriceRaw?: Scalars['numeric'] | null
  factory_id?: Scalars['String'] | null
  floorPriceFormatted?: Scalars['String'] | null
  floorPriceRaw?: Scalars['numeric'] | null
  floorSupplyFormatted?: Scalars['String'] | null
  floorSupplyRaw?: Scalars['numeric'] | null
  id?: Scalars['String'] | null
  initialFloorPriceFormatted?: Scalars['String'] | null
  initialFloorPriceRaw?: Scalars['numeric'] | null
  isBuyOpen?: Scalars['Boolean'] | null
  isSellOpen?: Scalars['Boolean'] | null
  issuanceToken_id?: Scalars['String'] | null
  lastElevationTimestamp?: Scalars['numeric'] | null
  lastTradeTimestamp?: Scalars['numeric'] | null
  lastUpdatedAt?: Scalars['numeric'] | null
  marketSupplyFormatted?: Scalars['String'] | null
  marketSupplyRaw?: Scalars['numeric'] | null
  maxLTV?: Scalars['numeric'] | null
  reserveToken_id?: Scalars['String'] | null
  sellFeeBps?: Scalars['numeric'] | null
  status?: Scalars['marketstatus'] | null
  totalSupplyFormatted?: Scalars['String'] | null
  totalSupplyRaw?: Scalars['numeric'] | null
  tradingFeeBps?: Scalars['numeric'] | null
}

/** order by sum() on columns of table "Market" */
export interface Market_sum_order_by {
  buyFeeBps?: order_by | null
  createdAt?: order_by | null
  currentPriceRaw?: order_by | null
  floorPriceRaw?: order_by | null
...
export interface Market_var_pop_order_by {
  buyFeeBps?: order_by | null
  createdAt?: order_by | null
  currentPriceRaw?: order_by | null
  floorPriceRaw?: order_by | null
...
export interface ModuleAddress_bool_exp {
  _and?: ModuleAddress_bool_exp[] | null
  _not?: ModuleAddress_bool_exp | null
  _or?: ModuleAddress_bool_exp[] | null
  createdAt?: numeric_comparison_exp | null
  id?: String_comparison_exp | null
  lastUpdatedAt?: numeric_comparison_exp | null
  market_id?: String_comparison_exp | null
  moduleType?: String_comparison_exp | null
}

/** Ordering options when selecting data from "ModuleAddress". */
export interface ModuleAddress_order_by {
  createdAt?: order_by | null
  id?: order_by | null
  lastUpdatedAt?: order_by | null
  market_id?: order_by | null
  moduleType?: order_by | null
}
...
/** Initial value of the column from where the streaming should start */
export interface ModuleAddress_stream_cursor_value_input {
  createdAt?: Scalars['numeric'] | null
  id?: Scalars['String'] | null
  lastUpdatedAt?: Scalars['numeric'] | null
  market_id?: Scalars['String'] | null
  moduleType?: Scalars['String'] | null
}
...
export interface ModuleRegistry_bool_exp {
  _and?: ModuleRegistry_bool_exp[] | null
  _not?: ModuleRegistry_bool_exp | null
  _or?: ModuleRegistry_bool_exp[] | null
  authorizer?: String_comparison_exp | null
  createdAt?: numeric_comparison_exp | null
  creditFacility?: String_comparison_exp | null
  feeTreasury?: String_comparison_exp | null
  floor?: String_comparison_exp | null
  id?: String_comparison_exp | null
  lastUpdatedAt?: numeric_comparison_exp | null
  presale?: String_comparison_exp | null
  staking?: String_comparison_exp | null
}

/** Ordering options when selecting data from "ModuleRegistry". */
export interface ModuleRegistry_order_by {
  authorizer?: order_by | null
  createdAt?: order_by | null
  creditFacility?: order_by | null
  feeTreasury?: order_by | null
  floor?: order_by | null
  id?: order_by | null
  lastUpdatedAt?: order_by | null
  presale?: order_by | null
...
export interface PreSaleContractGenqlSelection {
  authorizer?: boolean | number
  /** An array relationship */
  claims?: PresaleClaimGenqlSelection & {
    __args?: {
      /** distinct select on columns */
  ...
  /** An array relationship */
  participations?: PresaleParticipationGenqlSelection & {
    __args?: {
      /** distinct select on columns */
      distinct_on?: PresaleParticipation_select_column[] | null
      /** limit the number of rows returned */
...
export interface PreSaleContract_bool_exp {
  _and?: PreSaleContract_bool_exp[] | null
  _not?: PreSaleContract_bool_exp | null
  _or?: PreSaleContract_bool_exp[] | null
  authorizer?: String_comparison_exp | null
  claims?: PresaleClaim_bool_exp | null
  commissionBps?: String_array_comparison_exp | null
  createdAt?: numeric_comparison_exp | null
  currentState?: Int_comparison_exp | null
  decayDuration?: numeric_comparison_exp | null
  decayStartTime?: numeric_comparison_exp | null
  endTime?: numeric_comparison_exp | null
  feeTreasury?: String_comparison_exp | null
  globalDepositCapFormatted?: String_comparison_exp | null
  globalDepositCapRaw?: numeric_comparison_exp | null
  id?: String_comparison_exp | null
  initialMultiplier?: numeric_comparison_exp | null
  lastUpdatedAt?: numeric_comparison_exp | null
  lendingFacility?: String_comparison_exp | null
  market_id?: String_comparison_exp | null
  maxLeverage?: numeric_comparison_exp | null
  merkleRoot?: String_comparison_exp | null
  participations?: PresaleParticipation_bool_exp | null
  perAddressDepositCapFormatted?: String_comparison_exp | null
  perAddressDepositCapRaw?: numeric_comparison_exp | null
  priceBreakpointOffsets?: Int_array_comparison_exp | null
  priceBreakpointsFlat?: String_array_comparison_exp | null
  purchaseToken?: Token_bool_exp | null
  purchaseToken_id?: String_comparison_exp | null
  saleToken?: Token_bool_exp | null
  saleToken_id?: String_comparison_exp | null
  startTime?: numeric_comparison_exp | null
  timeSafeguardTs?: numeric_comparison_exp | null
  totalParticipants?: numeric_comparison_exp | null
  totalRaisedFormatted?: String_comparison_exp | null
  totalRaisedRaw?: numeric_comparison_exp | null
  whitelistSize?: numeric_comparison_exp | null
...
export interface PreSaleContract_order_by {
  authorizer?: order_by | null
  claims_aggregate?: PresaleClaim_aggregate_order_by | null
  commissionBps?: order_by | null
  createdAt?: order_by | null
  currentState?: order_by | null
  decayDuration?: order_by | null
  decayStartTime?: order_by | null
  endTime?: order_by | null
  feeTreasury?: order_by | null
  globalDepositCapFormatted?: order_by | null
  globalDepositCapRaw?: order_by | null
  id?: order_by | null
  initialMultiplier?: order_by | null
  lastUpdatedAt?: order_by | null
  lendingFacility?: order_by | null
  market_id?: order_by | null
  maxLeverage?: order_by | null
  merkleRoot?: order_by | null
  participations_aggregate?: PresaleParticipation_aggregate_order_by | null
  perAddressDepositCapFormatted?: order_by | null
  perAddressDepositCapRaw?: order_by | null
  priceBreakpointOffsets?: order_by | null
  priceBreakpointsFlat?: order_by | null
  purchaseToken?: Token_order_by | null
  purchaseToken_id?: order_by | null
  saleToken?: Token_order_by | null
  saleToken_id?: order_by | null
  startTime?: order_by | null
  timeSafeguardTs?: order_by | null
  totalParticipants?: order_by | null
  totalRaisedFormatted?: order_by | null
  totalRaisedRaw?: order_by | null
  whitelistSize?: order_by | null
  whitelistedAddresses?: order_by | null
}
...
/** Initial value of the column from where the streaming should start */
export interface PreSaleContract_stream_cursor_value_input {
  authorizer?: Scalars['String'] | null
  commissionBps?: Scalars['String'][] | null
  createdAt?: Scalars['numeric'] | null
  currentState?: Scalars['Int'] | null
  decayDuration?: Scalars['numeric'] | null
  decayStartTime?: Scalars['numeric'] | null
  endTime?: Scalars['numeric'] | null
  feeTreasury?: Scalars['String'] | null
  globalDepositCapFormatted?: Scalars['String'] | null
  globalDepositCapRaw?: Scalars['numeric'] | null
  id?: Scalars['String'] | null
  initialMultiplier?: Scalars['numeric'] | null
  lastUpdatedAt?: Scalars['numeric'] | null
  lendingFacility?: Scalars['String'] | null
  ...
  maxLeverage?: Scalars['numeric'] | null
  merkleRoot?: Scalars['String'] | null
  perAddressDepositCapFormatted?: Scalars['String'] | null
  perAddressDepositCapRaw?: Scalars['numeric'] | null
  priceBreakpointOffsets?: Scalars['Int'][] | null
  priceBreakpointsFlat?: Scalars['String'][] | null
  purchaseToken_id?: Scalars['String'] | null
  saleToken_id?: Scalars['String'] | null
  startTime?: Scalars['numeric'] | null
  timeSafeguardTs?: Scalars['numeric'] | null
  totalParticipants?: Scalars['numeric'] | null
  totalRaisedFormatted?: Scalars['String'] | null
  totalRaisedRaw?: Scalars['numeric'] | null
  whitelistSize?: Scalars['numeric'] | null
  whitelistedAddresses?: Scalars['String'][] | null
}
...
export interface PresaleClaim_aggregate_order_by {
  avg?: PresaleClaim_avg_order_by | null
  count?: order_by | null
  max?: PresaleClaim_max_order_by | null
  min?: PresaleClaim_min_order_by | null
  stddev?: PresaleClaim_stddev_order_by | null
  stddev_pop?: PresaleClaim_stddev_pop_order_by | null
  stddev_samp?: PresaleClaim_stddev_samp_order_by | null
  sum?: PresaleClaim_sum_order_by | null
  var_pop?: PresaleClaim_var_pop_order_by | null
  var_samp?: PresaleClaim_var_samp_order_by | null
  variance?: PresaleClaim_variance_order_by | null
}

/** order by avg() on columns of table "PresaleClaim" */
export interface PresaleClaim_avg_order_by {
  amountRaw?: order_by | null
  loanId?: order_by | null
  positionId?: order_by | null
  timestamp?: order_by | null
  trancheIndex?: order_by | null
}

/** Boolean expression to filter rows from the table "PresaleClaim". All fields are combined with a logical 'AND'. */
export interface PresaleClaim_bool_exp {
  _and?: PresaleClaim_bool_exp[] | null
  _not?: PresaleClaim_bool_exp | null
  _or?: PresaleClaim_bool_exp[] | null
  amountFormatted?: String_comparison_exp | null
  amountRaw?: numeric_comparison_exp | null
  claimType?: presaleclaimtype_comparison_exp | null
  id?: String_comparison_exp | null
  loanId?: numeric_comparison_exp | null
  positionId?: numeric_comparison_exp | null
  presale_id?: String_comparison_exp | null
  timestamp?: numeric_comparison_exp | null
...
export interface PresaleClaim_max_order_by {
  amountFormatted?: order_by | null
  amountRaw?: order_by | null
  claimType?: order_by | null
  id?: order_by | null
  loanId?: order_by | null
  positionId?: order_by | null
  presale_id?: order_by | null
  timestamp?: order_by | null
  trancheIndex?: order_by | null
  transactionHash?: order_by | null
}
...
export interface PresaleClaim_min_order_by {
  amountFormatted?: order_by | null
  amountRaw?: order_by | null
  claimType?: order_by | null
  id?: order_by | null
...
export interface PresaleClaim_order_by {
  amountFormatted?: order_by | null
  amountRaw?: order_by | null
  claimType?: order_by | null
  id?: order_by | null
...
export interface PresaleClaim_stddev_order_by {
  amountRaw?: order_by | null
  loanId?: order_by | null
  positionId?: order_by | null
  timestamp?: order_by | null
...
export interface PresaleClaim_stddev_pop_order_by {
  amountRaw?: order_by | null
  loanId?: order_by | null
  positionId?: order_by | null
  timestamp?: order_by | null
...
export interface PresaleClaim_stddev_samp_order_by {
  amountRaw?: order_by | null
  loanId?: order_by | null
  positionId?: order_by | null
  timestamp?: order_by | null
...
/** Initial value of the column from where the streaming should start */
export interface PresaleClaim_stream_cursor_value_input {
  amountFormatted?: Scalars['String'] | null
  amountRaw?: Scalars['numeric'] | null
  claimType?: Scalars['presaleclaimtype'] | null
  id?: Scalars['String'] | null
  loanId?: Scalars['numeric'] | null
  positionId?: Scalars['numeric'] | null
  presale_id?: Scalars['String'] | null
  timestamp?: Scalars['numeric'] | null
  trancheIndex?: Scalars['numeric'] | null
  transactionHash?: Scalars['String'] | null
}
...
export interface PresaleClaim_sum_order_by {
  amountRaw?: order_by | null
  loanId?: order_by | null
  positionId?: order_by | null
  timestamp?: order_by | null
...
export interface PresaleClaim_var_pop_order_by {
  amountRaw?: order_by | null
  loanId?: order_by | null
  positionId?: order_by | null
  timestamp?: order_by | null
...
export interface PresaleClaim_var_samp_order_by {
  amountRaw?: order_by | null
  loanId?: order_by | null
  positionId?: order_by | null
  timestamp?: order_by | null
...
export interface PresaleClaim_variance_order_by {
  amountRaw?: order_by | null
  loanId?: order_by | null
  positionId?: order_by | null
  timestamp?: order_by | null
...
export interface PresaleParticipation_aggregate_order_by {
  avg?: PresaleParticipation_avg_order_by | null
  count?: order_by | null
  max?: PresaleParticipation_max_order_by | null
  min?: PresaleParticipation_min_order_by | null
  stddev?: PresaleParticipation_stddev_order_by | null
  stddev_pop?: PresaleParticipation_stddev_pop_order_by | null
  stddev_samp?: PresaleParticipation_stddev_samp_order_by | null
  sum?: PresaleParticipation_sum_order_by | null
  var_pop?: PresaleParticipation_var_pop_order_by | null
  var_samp?: PresaleParticipation_var_samp_order_by | null
  variance?: PresaleParticipation_variance_order_by | null
}

/** order by avg() on columns of table "PresaleParticipation" */
export interface PresaleParticipation_avg_order_by {
  depositAmountRaw?: order_by | null
  leverage?: order_by | null
  loopCount?: order_by | null
  mintedAmountRaw?: order_by | null
  positionId?: order_by | null
  timestamp?: order_by | null
}

/** Boolean expression to filter rows from the table "PresaleParticipation". All fields are combined with a logical 'AND'. */
export interface PresaleParticipation_bool_exp {
  _and?: PresaleParticipation_bool_exp[] | null
  _not?: PresaleParticipation_bool_exp | null
  _or?: PresaleParticipation_bool_exp[] | null
  depositAmountFormatted?: String_comparison_exp | null
  depositAmountRaw?: numeric_comparison_exp | null
  id?: String_comparison_exp | null
  leverage?: numeric_comparison_exp | null
  loopCount?: numeric_comparison_exp | null
  mintedAmountFormatted?: String_comparison_exp | null
  mintedAmountRaw?: numeric_comparison_exp | null
  positionId?: numeric_comparison_exp | null
  presale_id?: String_comparison_exp | null
  timestamp?: numeric_comparison_exp | null
  transactionHash?: String_comparison_exp | null
...
export interface PresaleParticipation_max_order_by {
  depositAmountFormatted?: order_by | null
  depositAmountRaw?: order_by | null
  id?: order_by | null
  leverage?: order_by | null
  loopCount?: order_by | null
  mintedAmountFormatted?: order_by | null
  mintedAmountRaw?: order_by | null
  positionId?: order_by | null
  presale_id?: order_by | null
  timestamp?: order_by | null
...
export interface PresaleParticipation_min_order_by {
  depositAmountFormatted?: order_by | null
  depositAmountRaw?: order_by | null
  id?: order_by | null
  leverage?: order_by | null
...
export interface PresaleParticipation_order_by {
  depositAmountFormatted?: order_by | null
  depositAmountRaw?: order_by | null
  id?: order_by | null
  leverage?: order_by | null
...
export interface PresaleParticipation_stddev_order_by {
  depositAmountRaw?: order_by | null
  leverage?: order_by | null
  loopCount?: order_by | null
  mintedAmountRaw?: order_by | null
...
export interface PresaleParticipation_stddev_pop_order_by {
  depositAmountRaw?: order_by | null
  leverage?: order_by | null
  loopCount?: order_by | null
  mintedAmountRaw?: order_by | null
...
export interface PresaleParticipation_stddev_samp_order_by {
  depositAmountRaw?: order_by | null
  leverage?: order_by | null
  loopCount?: order_by | null
  mintedAmountRaw?: order_by | null
...
/** Initial value of the column from where the streaming should start */
export interface PresaleParticipation_stream_cursor_value_input {
  depositAmountFormatted?: Scalars['String'] | null
  depositAmountRaw?: Scalars['numeric'] | null
  id?: Scalars['String'] | null
  leverage?: Scalars['numeric'] | null
  loopCount?: Scalars['numeric'] | null
  mintedAmountFormatted?: Scalars['String'] | null
  mintedAmountRaw?: Scalars['numeric'] | null
  positionId?: Scalars['numeric'] | null
...
export interface PresaleParticipation_sum_order_by {
  depositAmountRaw?: order_by | null
  leverage?: order_by | null
  loopCount?: order_by | null
  mintedAmountRaw?: order_by | null
...
export interface PresaleParticipation_var_pop_order_by {
  depositAmountRaw?: order_by | null
  leverage?: order_by | null
  loopCount?: order_by | null
  mintedAmountRaw?: order_by | null
...
export interface PresaleParticipation_var_samp_order_by {
  depositAmountRaw?: order_by | null
  leverage?: order_by | null
  loopCount?: order_by | null
  mintedAmountRaw?: order_by | null
...
export interface PresaleParticipation_variance_order_by {
  depositAmountRaw?: order_by | null
  leverage?: order_by | null
  loopCount?: order_by | null
  mintedAmountRaw?: order_by | null
...
export interface PriceCandle_bool_exp {
  _and?: PriceCandle_bool_exp[] | null
  _not?: PriceCandle_bool_exp | null
  _or?: PriceCandle_bool_exp[] | null
  closeFormatted?: String_comparison_exp | null
  closeRaw?: numeric_comparison_exp | null
  highFormatted?: String_comparison_exp | null
  highRaw?: numeric_comparison_exp | null
  id?: String_comparison_exp | null
  lowFormatted?: String_comparison_exp | null
  lowRaw?: numeric_comparison_exp | null
  market_id?: String_comparison_exp | null
  openFormatted?: String_comparison_exp | null
  openRaw?: numeric_comparison_exp | null
  period?: candleperiod_comparison_exp | null
  timestamp?: numeric_comparison_exp | null
  trades?: numeric_comparison_exp | null
  volumeFormatted?: String_comparison_exp | null
  volumeRaw?: numeric_comparison_exp | null
}

/** Ordering options when selecting data from "PriceCandle". */
export interface PriceCandle_order_by {
  closeFormatted?: order_by | null
  closeRaw?: order_by | null
  highFormatted?: order_by | null
  highRaw?: order_by | null
  id?: order_by | null
  lowFormatted?: order_by | null
  lowRaw?: order_by | null
  market_id?: order_by | null
  openFormatted?: order_by | null
  openRaw?: order_by | null
  period?: order_by | null
  timestamp?: order_by | null
  trades?: order_by | null
  volumeFormatted?: order_by | null
  volumeRaw?: order_by | null
}
...
export interface PriceCandle_stream_cursor_value_input {
  closeFormatted?: Scalars['String'] | null
  closeRaw?: Scalars['numeric'] | null
  highFormatted?: Scalars['String'] | null
  highRaw?: Scalars['numeric'] | null
  id?: Scalars['String'] | null
  lowFormatted?: Scalars['String'] | null
  lowRaw?: Scalars['numeric'] | null
  market_id?: Scalars['String'] | null
  openFormatted?: Scalars['String'] | null
  openRaw?: Scalars['numeric'] | null
  period?: Scalars['candleperiod'] | null
  timestamp?: Scalars['numeric'] | null
  trades?: Scalars['numeric'] | null
  volumeFormatted?: Scalars['String'] | null
  volumeRaw?: Scalars['numeric'] | null
}
...
export interface RoleGenqlSelection {
  ...
  lastUpdatedAt?: boolean | number
  /** An array relationship */
  members?: RoleMemberGenqlSelection & {
    __args?: {
      /** distinct select on columns */
  ...
  name?: boolean | number
  /** An array relationship */
  permissions?: RolePermissionGenqlSelection & {
    __args?: {
      /** distinct select on columns */
...
export interface RoleMember_aggregate_order_by {
  avg?: RoleMember_avg_order_by | null
  count?: order_by | null
  max?: RoleMember_max_order_by | null
  min?: RoleMember_min_order_by | null
  stddev?: RoleMember_stddev_order_by | null
  stddev_pop?: RoleMember_stddev_pop_order_by | null
  stddev_samp?: RoleMember_stddev_samp_order_by | null
  sum?: RoleMember_sum_order_by | null
  var_pop?: RoleMember_var_pop_order_by | null
  var_samp?: RoleMember_var_samp_order_by | null
  variance?: RoleMember_variance_order_by | null
}

/** order by avg() on columns of table "RoleMember" */
export interface RoleMember_avg_order_by {
  grantedAt?: order_by | null
}

/** Boolean expression to filter rows from the table "RoleMember". All fields are combined with a logical 'AND'. */
export interface RoleMember_bool_exp {
  _and?: RoleMember_bool_exp[] | null
  _not?: RoleMember_bool_exp | null
  _or?: RoleMember_bool_exp[] | null
  grantedAt?: numeric_comparison_exp | null
  grantedBy?: String_comparison_exp | null
  id?: String_comparison_exp | null
  member?: String_comparison_exp | null
  role_id?: String_comparison_exp | null
  transactionHash?: String_comparison_exp | null
}

/** order by max() on columns of table "RoleMember" */
export interface RoleMember_max_order_by {
  grantedAt?: order_by | null
  grantedBy?: order_by | null
  id?: order_by | null
  member?: order_by | null
  role_id?: order_by | null
  transactionHash?: order_by | null
}

/** order by min() on columns of table "RoleMember" */
export interface RoleMember_min_order_by {
  grantedAt?: order_by | null
  grantedBy?: order_by | null
  id?: order_by | null
  member?: order_by | null
...
export interface RoleMember_order_by {
  grantedAt?: order_by | null
  grantedBy?: order_by | null
  id?: order_by | null
  member?: order_by | null
...
export interface RoleMember_stddev_order_by {
  grantedAt?: order_by | null
}

/** order by stddev_pop() on columns of table "RoleMember" */
export interface RoleMember_stddev_pop_order_by {
  grantedAt?: order_by | null
}

/** order by stddev_samp() on columns of table "RoleMember" */
export interface RoleMember_stddev_samp_order_by {
  grantedAt?: order_by | null
}
...
/** Initial value of the column from where the streaming should start */
export interface RoleMember_stream_cursor_value_input {
  grantedAt?: Scalars['numeric'] | null
  grantedBy?: Scalars['String'] | null
  id?: Scalars['String'] | null
  member?: Scalars['String'] | null
  role_id?: Scalars['String'] | null
  transactionHash?: Scalars['String'] | null
}

/** order by sum() on columns of table "RoleMember" */
export interface RoleMember_sum_order_by {
  grantedAt?: order_by | null
}

/** order by var_pop() on columns of table "RoleMember" */
export interface RoleMember_var_pop_order_by {
  grantedAt?: order_by | null
}

/** order by var_samp() on columns of table "RoleMember" */
export interface RoleMember_var_samp_order_by {
  grantedAt?: order_by | null
}

/** order by variance() on columns of table "RoleMember" */
export interface RoleMember_variance_order_by {
  grantedAt?: order_by | null
}
...
export interface RolePermission_aggregate_order_by {
  avg?: RolePermission_avg_order_by | null
  count?: order_by | null
  max?: RolePermission_max_order_by | null
  min?: RolePermission_min_order_by | null
  stddev?: RolePermission_stddev_order_by | null
  stddev_pop?: RolePermission_stddev_pop_order_by | null
  stddev_samp?: RolePermission_stddev_samp_order_by | null
  sum?: RolePermission_sum_order_by | null
  var_pop?: RolePermission_var_pop_order_by | null
  var_samp?: RolePermission_var_samp_order_by | null
  variance?: RolePermission_variance_order_by | null
}

/** order by avg() on columns of table "RolePermission" */
export interface RolePermission_avg_order_by {
  addedAt?: order_by | null
}
...
export interface RolePermission_bool_exp {
  _and?: RolePermission_bool_exp[] | null
  _not?: RolePermission_bool_exp | null
  _or?: RolePermission_bool_exp[] | null
  addedAt?: numeric_comparison_exp | null
  id?: String_comparison_exp | null
  role_id?: String_comparison_exp | null
  selector?: String_comparison_exp | null
  selectorName?: String_comparison_exp | null
  target?: String_comparison_exp | null
  transactionHash?: String_comparison_exp | null
}

/** order by max() on columns of table "RolePermission" */
export interface RolePermission_max_order_by {
  addedAt?: order_by | null
  id?: order_by | null
  role_id?: order_by | null
  selector?: order_by | null
  selectorName?: order_by | null
  target?: order_by | null
  transactionHash?: order_by | null
}

/** order by min() on columns of table "RolePermission" */
export interface RolePermission_min_order_by {
  addedAt?: order_by | null
  id?: order_by | null
  role_id?: order_by | null
  selector?: order_by | null
...
export interface RolePermission_order_by {
  addedAt?: order_by | null
  id?: order_by | null
  role_id?: order_by | null
  selector?: order_by | null
...
export interface RolePermission_stddev_order_by {
  addedAt?: order_by | null
}

/** order by stddev_pop() on columns of table "RolePermission" */
export interface RolePermission_stddev_pop_order_by {
  addedAt?: order_by | null
}

/** order by stddev_samp() on columns of table "RolePermission" */
export interface RolePermission_stddev_samp_order_by {
  addedAt?: order_by | null
}
...
/** Initial value of the column from where the streaming should start */
export interface RolePermission_stream_cursor_value_input {
  addedAt?: Scalars['numeric'] | null
  id?: Scalars['String'] | null
  role_id?: Scalars['String'] | null
  selector?: Scalars['String'] | null
  selectorName?: Scalars['String'] | null
  target?: Scalars['String'] | null
  transactionHash?: Scalars['String'] | null
}

/** order by sum() on columns of table "RolePermission" */
export interface RolePermission_sum_order_by {
  addedAt?: order_by | null
}

/** order by var_pop() on columns of table "RolePermission" */
export interface RolePermission_var_pop_order_by {
  addedAt?: order_by | null
}

/** order by var_samp() on columns of table "RolePermission" */
export interface RolePermission_var_samp_order_by {
  addedAt?: order_by | null
}

/** order by variance() on columns of table "RolePermission" */
export interface RolePermission_variance_order_by {
  addedAt?: order_by | null
}
...
export interface Role_bool_exp {
  ...
  adminRole?: String_comparison_exp | null
  adminRoleName?: String_comparison_exp | null
  authorizer_id?: String_comparison_exp | null
  createdAt?: numeric_comparison_exp | null
  id?: String_comparison_exp | null
  isAdminBurned?: Boolean_comparison_exp | null
  lastUpdatedAt?: numeric_comparison_exp | null
  members?: RoleMember_bool_exp | null
  name?: String_comparison_exp | null
  permissions?: RolePermission_bool_exp | null
  roleId?: String_comparison_exp | null
}

/** order by max() on columns of table "Role" */
export interface Role_max_order_by {
  adminRole?: order_by | null
  adminRoleName?: order_by | null
  authorizer_id?: order_by | null
  createdAt?: order_by | null
  id?: order_by | null
  lastUpdatedAt?: order_by | null
  name?: order_by | null
  roleId?: order_by | null
}
...
export interface Role_order_by {
  ...
  createdAt?: order_by | null
  id?: order_by | null
  isAdminBurned?: order_by | null
  lastUpdatedAt?: order_by | null
  members_aggregate?: RoleMember_aggregate_order_by | null
  name?: order_by | null
  permissions_aggregate?: RolePermission_aggregate_order_by | null
  roleId?: order_by | null
}
...
export interface Role_stream_cursor_value_input {
  ...
  createdAt?: Scalars['numeric'] | null
  id?: Scalars['String'] | null
  isAdminBurned?: Scalars['Boolean'] | null
  lastUpdatedAt?: Scalars['numeric'] | null
  name?: Scalars['String'] | null
  roleId?: Scalars['String'] | null
}
...
export interface StakePositionGenqlSelection {
  /** An array relationship */
  activities?: StakingActivityGenqlSelection & {
    __args?: {
      /** distinct select on columns */
...
export interface StakePosition_aggregate_order_by {
  avg?: StakePosition_avg_order_by | null
  count?: order_by | null
  max?: StakePosition_max_order_by | null
  min?: StakePosition_min_order_by | null
  stddev?: StakePosition_stddev_order_by | null
  stddev_pop?: StakePosition_stddev_pop_order_by | null
  stddev_samp?: StakePosition_stddev_samp_order_by | null
  sum?: StakePosition_sum_order_by | null
  var_pop?: StakePosition_var_pop_order_by | null
  var_samp?: StakePosition_var_samp_order_by | null
  variance?: StakePosition_variance_order_by | null
}

/** order by avg() on columns of table "StakePosition" */
export interface StakePosition_avg_order_by {
  collateralDeployedRaw?: order_by | null
  createdAt?: order_by | null
  floorPriceAtStakeRaw?: order_by | null
  issuanceTokenAmountRaw?: order_by | null
  lastUpdatedAt?: order_by | null
  totalFeePaidRaw?: order_by | null
  totalYieldHarvestedRaw?: order_by | null
}

/** Boolean expression to filter rows from the table "StakePosition". All fields are combined with a logical 'AND'. */
export interface StakePosition_bool_exp {
  _and?: StakePosition_bool_exp[] | null
  _not?: StakePosition_bool_exp | null
  _or?: StakePosition_bool_exp[] | null
  activities?: StakingActivity_bool_exp | null
  collateralDeployedFormatted?: String_comparison_exp | null
  collateralDeployedRaw?: numeric_comparison_exp | null
  createdAt?: numeric_comparison_exp | null
  floorPriceAtStakeFormatted?: String_comparison_exp | null
  floorPriceAtStakeRaw?: numeric_comparison_exp | null
  id?: String_comparison_exp | null
  issuanceTokenAmountFormatted?: String_comparison_exp | null
  issuanceTokenAmountRaw?: numeric_comparison_exp | null
  lastUpdatedAt?: numeric_comparison_exp | null
  stakingManager_id?: String_comparison_exp | null
  status?: stakepositionstatus_comparison_exp | null
  strategy_id?: String_comparison_exp | null
  totalFeePaidFormatted?: String_comparison_exp | null
  totalFeePaidRaw?: numeric_comparison_exp | null
  totalYieldHarvestedFormatted?: String_comparison_exp | null
  totalYieldHarvestedRaw?: numeric_comparison_exp | null
  transactionHash?: String_comparison_exp | null
  user_id?: String_comparison_exp | null
}
...
export interface StakePosition_max_order_by {
  collateralDeployedFormatted?: order_by | null
  collateralDeployedRaw?: order_by | null
  createdAt?: order_by | null
  floorPriceAtStakeFormatted?: order_by | null
  floorPriceAtStakeRaw?: order_by | null
  id?: order_by | null
  issuanceTokenAmountFormatted?: order_by | null
  issuanceTokenAmountRaw?: order_by | null
  lastUpdatedAt?: order_by | null
  stakingManager_id?: order_by | null
  status?: order_by | null
  strategy_id?: order_by | null
  totalFeePaidFormatted?: order_by | null
  totalFeePaidRaw?: order_by | null
  totalYieldHarvestedFormatted?: order_by | null
  totalYieldHarvestedRaw?: order_by | null
  transactionHash?: order_by | null
  user_id?: order_by | null
}
...
export interface StakePosition_min_order_by {
  collateralDeployedFormatted?: order_by | null
  collateralDeployedRaw?: order_by | null
  createdAt?: order_by | null
  floorPriceAtStakeFormatted?: order_by | null
...
export interface StakePosition_order_by {
  activities_aggregate?: StakingActivity_aggregate_order_by | null
  collateralDeployedFormatted?: order_by | null
  collateralDeployedRaw?: order_by | null
  createdAt?: order_by | null
  floorPriceAtStakeFormatted?: order_by | null
...
export interface StakePosition_stddev_order_by {
  collateralDeployedRaw?: order_by | null
  createdAt?: order_by | null
  floorPriceAtStakeRaw?: order_by | null
  issuanceTokenAmountRaw?: order_by | null
...
export interface StakePosition_stddev_pop_order_by {
  collateralDeployedRaw?: order_by | null
  createdAt?: order_by | null
  floorPriceAtStakeRaw?: order_by | null
  issuanceTokenAmountRaw?: order_by | null
...
export interface StakePosition_stddev_samp_order_by {
  collateralDeployedRaw?: order_by | null
  createdAt?: order_by | null
  floorPriceAtStakeRaw?: order_by | null
  issuanceTokenAmountRaw?: order_by | null
...
export interface StakePosition_stream_cursor_value_input {
  collateralDeployedFormatted?: Scalars['String'] | null
  collateralDeployedRaw?: Scalars['numeric'] | null
  createdAt?: Scalars['numeric'] | null
  floorPriceAtStakeFormatted?: Scalars['String'] | null
  floorPriceAtStakeRaw?: Scalars['numeric'] | null
  id?: Scalars['String'] | null
  issuanceTokenAmountFormatted?: Scalars['String'] | null
  issuanceTokenAmountRaw?: Scalars['numeric'] | null
  lastUpdatedAt?: Scalars['numeric'] | null
  stakingManager_id?: Scalars['String'] | null
  status?: Scalars['stakepositionstatus'] | null
  strategy_id?: Scalars['String'] | null
  totalFeePaidFormatted?: Scalars['String'] | null
  totalFeePaidRaw?: Scalars['numeric'] | null
  totalYieldHarvestedFormatted?: Scalars['String'] | null
  totalYieldHarvestedRaw?: Scalars['numeric'] | null
  transactionHash?: Scalars['String'] | null
  user_id?: Scalars['String'] | null
}

/** order by sum() on columns of table "StakePosition" */
export interface StakePosition_sum_order_by {
  collateralDeployedRaw?: order_by | null
  createdAt?: order_by | null
  floorPriceAtStakeRaw?: order_by | null
  issuanceTokenAmountRaw?: order_by | null
...
export interface StakePosition_var_pop_order_by {
  collateralDeployedRaw?: order_by | null
  createdAt?: order_by | null
  floorPriceAtStakeRaw?: order_by | null
  issuanceTokenAmountRaw?: order_by | null
...
export interface StakePosition_var_samp_order_by {
  collateralDeployedRaw?: order_by | null
  createdAt?: order_by | null
  floorPriceAtStakeRaw?: order_by | null
  issuanceTokenAmountRaw?: order_by | null
...
export interface StakePosition_variance_order_by {
  collateralDeployedRaw?: order_by | null
  createdAt?: order_by | null
  floorPriceAtStakeRaw?: order_by | null
  issuanceTokenAmountRaw?: order_by | null
...
export interface StakingActivity_aggregate_order_by {
  avg?: StakingActivity_avg_order_by | null
  count?: order_by | null
  max?: StakingActivity_max_order_by | null
  min?: StakingActivity_min_order_by | null
  stddev?: StakingActivity_stddev_order_by | null
  stddev_pop?: StakingActivity_stddev_pop_order_by | null
  stddev_samp?: StakingActivity_stddev_samp_order_by | null
  sum?: StakingActivity_sum_order_by | null
  var_pop?: StakingActivity_var_pop_order_by | null
  var_samp?: StakingActivity_var_samp_order_by | null
  variance?: StakingActivity_variance_order_by | null
}

/** order by avg() on columns of table "StakingActivity" */
export interface StakingActivity_avg_order_by {
  collateralAmountRaw?: order_by | null
  feeAmountRaw?: order_by | null
  issuanceTokenAmountRaw?: order_by | null
  timestamp?: order_by | null
  yieldAmountRaw?: order_by | null
}
...
export interface StakingActivity_bool_exp {
  _and?: StakingActivity_bool_exp[] | null
  _not?: StakingActivity_bool_exp | null
  _or?: StakingActivity_bool_exp[] | null
  activityType?: stakingactivitytype_comparison_exp | null
  collateralAmountFormatted?: String_comparison_exp | null
  collateralAmountRaw?: numeric_comparison_exp | null
  feeAmountFormatted?: String_comparison_exp | null
  feeAmountRaw?: numeric_comparison_exp | null
  id?: String_comparison_exp | null
  issuanceTokenAmountFormatted?: String_comparison_exp | null
  issuanceTokenAmountRaw?: numeric_comparison_exp | null
  ...
  transactionHash?: String_comparison_exp | null
  user_id?: String_comparison_exp | null
  yieldAmountFormatted?: String_comparison_exp | null
  yieldAmountRaw?: numeric_comparison_exp | null
}

/** order by max() on columns of table "StakingActivity" */
export interface StakingActivity_max_order_by {
  activityType?: order_by | null
  collateralAmountFormatted?: order_by | null
  collateralAmountRaw?: order_by | null
  feeAmountFormatted?: order_by | null
  feeAmountRaw?: order_by | null
  id?: order_by | null
  issuanceTokenAmountFormatted?: order_by | null
  issuanceTokenAmountRaw?: order_by | null
  ...
  transactionHash?: order_by | null
  user_id?: order_by | null
  yieldAmountFormatted?: order_by | null
  yieldAmountRaw?: order_by | null
}

/** order by min() on columns of table "StakingActivity" */
export interface StakingActivity_min_order_by {
  activityType?: order_by | null
  collateralAmountFormatted?: order_by | null
  collateralAmountRaw?: order_by | null
  feeAmountFormatted?: order_by | null
...
export interface StakingActivity_order_by {
  activityType?: order_by | null
  collateralAmountFormatted?: order_by | null
  collateralAmountRaw?: order_by | null
  feeAmountFormatted?: order_by | null
...
export interface StakingActivity_stddev_order_by {
  collateralAmountRaw?: order_by | null
  feeAmountRaw?: order_by | null
  issuanceTokenAmountRaw?: order_by | null
  timestamp?: order_by | null
...
export interface StakingActivity_stddev_pop_order_by {
  collateralAmountRaw?: order_by | null
  feeAmountRaw?: order_by | null
  issuanceTokenAmountRaw?: order_by | null
  timestamp?: order_by | null
...
export interface StakingActivity_stddev_samp_order_by {
  collateralAmountRaw?: order_by | null
  feeAmountRaw?: order_by | null
  issuanceTokenAmountRaw?: order_by | null
  timestamp?: order_by | null
...
/** Initial value of the column from where the streaming should start */
export interface StakingActivity_stream_cursor_value_input {
  activityType?: Scalars['stakingactivitytype'] | null
  collateralAmountFormatted?: Scalars['String'] | null
  collateralAmountRaw?: Scalars['numeric'] | null
  feeAmountFormatted?: Scalars['String'] | null
  feeAmountRaw?: Scalars['numeric'] | null
...
export interface StakingActivity_sum_order_by {
  collateralAmountRaw?: order_by | null
  feeAmountRaw?: order_by | null
  issuanceTokenAmountRaw?: order_by | null
  timestamp?: order_by | null
...
export interface StakingActivity_var_pop_order_by {
  collateralAmountRaw?: order_by | null
  feeAmountRaw?: order_by | null
  issuanceTokenAmountRaw?: order_by | null
  timestamp?: order_by | null
...
export interface StakingActivity_var_samp_order_by {
  collateralAmountRaw?: order_by | null
  feeAmountRaw?: order_by | null
  issuanceTokenAmountRaw?: order_by | null
  timestamp?: order_by | null
...
export interface StakingActivity_variance_order_by {
  collateralAmountRaw?: order_by | null
  feeAmountRaw?: order_by | null
  issuanceTokenAmountRaw?: order_by | null
  timestamp?: order_by | null
...
export interface StakingManagerGenqlSelection {
  ...
  /** An array relationship */
  positions?: StakePositionGenqlSelection & {
    __args?: {
      /** distinct select on columns */
      distinct_on?: StakePosition_select_column[] | null
      /** limit the number of rows returned */
...
export interface StakingManager_bool_exp {
  _and?: StakingManager_bool_exp[] | null
  _not?: StakingManager_bool_exp | null
  _or?: StakingManager_bool_exp[] | null
  createdAt?: numeric_comparison_exp | null
  id?: String_comparison_exp | null
  lastUpdatedAt?: numeric_comparison_exp | null
  market_id?: String_comparison_exp | null
  performanceFeeBps?: numeric_comparison_exp | null
  positions?: StakePosition_bool_exp | null
  strategies?: Strategy_bool_exp | null
  totalCollateralDeployedFormatted?: String_comparison_exp | null
  totalCollateralDeployedRaw?: numeric_comparison_exp | null
  totalFeesCapturedFormatted?: String_comparison_exp | null
  totalFeesCapturedRaw?: numeric_comparison_exp | null
  totalStakedIssuanceFormatted?: String_comparison_exp | null
  totalStakedIssuanceRaw?: numeric_comparison_exp | null
  totalYieldHarvestedFormatted?: String_comparison_exp | null
  totalYieldHarvestedRaw?: numeric_comparison_exp | null
}

/** Ordering options when selecting data from "StakingManager". */
export interface StakingManager_order_by {
  createdAt?: order_by | null
  id?: order_by | null
  lastUpdatedAt?: order_by | null
  market_id?: order_by | null
  performanceFeeBps?: order_by | null
  positions_aggregate?: StakePosition_aggregate_order_by | null
  strategies_aggregate?: Strategy_aggregate_order_by | null
  totalCollateralDeployedFormatted?: order_by | null
  totalCollateralDeployedRaw?: order_by | null
  totalFeesCapturedFormatted?: order_by | null
  totalFeesCapturedRaw?: order_by | null
  totalStakedIssuanceFormatted?: order_by | null
  totalStakedIssuanceRaw?: order_by | null
  totalYieldHarvestedFormatted?: order_by | null
  totalYieldHarvestedRaw?: order_by | null
}
...
/** Initial value of the column from where the streaming should start */
export interface StakingManager_stream_cursor_value_input {
  createdAt?: Scalars['numeric'] | null
  id?: Scalars['String'] | null
  lastUpdatedAt?: Scalars['numeric'] | null
  market_id?: Scalars['String'] | null
  performanceFeeBps?: Scalars['numeric'] | null
  totalCollateralDeployedFormatted?: Scalars['String'] | null
  totalCollateralDeployedRaw?: Scalars['numeric'] | null
  totalFeesCapturedFormatted?: Scalars['String'] | null
  totalFeesCapturedRaw?: Scalars['numeric'] | null
  totalStakedIssuanceFormatted?: Scalars['String'] | null
  totalStakedIssuanceRaw?: Scalars['numeric'] | null
  totalYieldHarvestedFormatted?: Scalars['String'] | null
  totalYieldHarvestedRaw?: Scalars['numeric'] | null
}
...
export interface Strategy_aggregate_order_by {
  avg?: Strategy_avg_order_by | null
  count?: order_by | null
  max?: Strategy_max_order_by | null
  min?: Strategy_min_order_by | null
  stddev?: Strategy_stddev_order_by | null
  stddev_pop?: Strategy_stddev_pop_order_by | null
  stddev_samp?: Strategy_stddev_samp_order_by | null
  sum?: Strategy_sum_order_by | null
  var_pop?: Strategy_var_pop_order_by | null
  var_samp?: Strategy_var_samp_order_by | null
  variance?: Strategy_variance_order_by | null
}

/** order by avg() on columns of table "Strategy" */
export interface Strategy_avg_order_by {
  addedAt?: order_by | null
  removedAt?: order_by | null
}

/** Boolean expression to filter rows from the table "Strategy". All fields are combined with a logical 'AND'. */
export interface Strategy_bool_exp {
  _and?: Strategy_bool_exp[] | null
  _not?: Strategy_bool_exp | null
  _or?: Strategy_bool_exp[] | null
  addedAt?: numeric_comparison_exp | null
  id?: String_comparison_exp | null
  isActive?: Boolean_comparison_exp | null
  name?: String_comparison_exp | null
  positions?: StakePosition_bool_exp | null
  removedAt?: numeric_comparison_exp | null
  stakingManager_id?: String_comparison_exp | null
...
export interface Strategy_max_order_by {
  addedAt?: order_by | null
  id?: order_by | null
  name?: order_by | null
  removedAt?: order_by | null
...
export interface Strategy_min_order_by {
  addedAt?: order_by | null
  id?: order_by | null
  name?: order_by | null
  removedAt?: order_by | null
...
export interface Strategy_stddev_order_by {
  addedAt?: order_by | null
  removedAt?: order_by | null
}

/** order by stddev_pop() on columns of table "Strategy" */
export interface Strategy_stddev_pop_order_by {
  addedAt?: order_by | null
  removedAt?: order_by | null
}

/** order by stddev_samp() on columns of table "Strategy" */
export interface Strategy_stddev_samp_order_by {
  addedAt?: order_by | null
  removedAt?: order_by | null
}
...
/** Initial value of the column from where the streaming should start */
export interface Strategy_stream_cursor_value_input {
  addedAt?: Scalars['numeric'] | null
  id?: Scalars['String'] | null
...
export interface Strategy_sum_order_by {
  addedAt?: order_by | null
  removedAt?: order_by | null
}

/** order by var_pop() on columns of table "Strategy" */
export interface Strategy_var_pop_order_by {
  addedAt?: order_by | null
  removedAt?: order_by | null
}

/** order by var_samp() on columns of table "Strategy" */
export interface Strategy_var_samp_order_by {
  addedAt?: order_by | null
  removedAt?: order_by | null
}

/** order by variance() on columns of table "Strategy" */
export interface Strategy_variance_order_by {
  addedAt?: order_by | null
  removedAt?: order_by | null
}
...
export interface Token_bool_exp {
  ...
  id?: String_comparison_exp | null
  maxSupplyFormatted?: String_comparison_exp | null
  maxSupplyRaw?: numeric_comparison_exp | null
  name?: String_comparison_exp | null
  symbol?: String_comparison_exp | null
}
...
export interface Token_order_by {
  ...
  id?: order_by | null
  maxSupplyFormatted?: order_by | null
  maxSupplyRaw?: order_by | null
  name?: order_by | null
  symbol?: order_by | null
}
...
export interface Token_stream_cursor_value_input {
  ...
  id?: Scalars['String'] | null
  maxSupplyFormatted?: Scalars['String'] | null
  maxSupplyRaw?: Scalars['numeric'] | null
  name?: Scalars['String'] | null
  symbol?: Scalars['String'] | null
}
...
export interface Trade_aggregate_order_by {
  avg?: Trade_avg_order_by | null
  count?: order_by | null
  max?: Trade_max_order_by | null
  min?: Trade_min_order_by | null
  stddev?: Trade_stddev_order_by | null
  stddev_pop?: Trade_stddev_pop_order_by | null
  stddev_samp?: Trade_stddev_samp_order_by | null
  sum?: Trade_sum_order_by | null
  var_pop?: Trade_var_pop_order_by | null
  var_samp?: Trade_var_samp_order_by | null
  variance?: Trade_variance_order_by | null
}

/** order by avg() on columns of table "Trade" */
export interface Trade_avg_order_by {
  feeRaw?: order_by | null
  newPriceRaw?: order_by | null
  reserveAmountRaw?: order_by | null
  timestamp?: order_by | null
  tokenAmountRaw?: order_by | null
}
...
export interface Trade_bool_exp {
  _and?: Trade_bool_exp[] | null
  _not?: Trade_bool_exp | null
  _or?: Trade_bool_exp[] | null
  feeFormatted?: String_comparison_exp | null
  feeRaw?: numeric_comparison_exp | null
  id?: String_comparison_exp | null
  market_id?: String_comparison_exp | null
  newPriceFormatted?: String_comparison_exp | null
  newPriceRaw?: numeric_comparison_exp | null
  reserveAmountFormatted?: String_comparison_exp | null
  reserveAmountRaw?: numeric_comparison_exp | null
  timestamp?: numeric_comparison_exp | null
  tokenAmountFormatted?: String_comparison_exp | null
  tokenAmountRaw?: numeric_comparison_exp | null
  tradeType?: tradetype_comparison_exp | null
  transactionHash?: String_comparison_exp | null
  user_id?: String_comparison_exp | null
}

/** order by max() on columns of table "Trade" */
export interface Trade_max_order_by {
  feeFormatted?: order_by | null
  feeRaw?: order_by | null
  id?: order_by | null
  market_id?: order_by | null
  newPriceFormatted?: order_by | null
  newPriceRaw?: order_by | null
  reserveAmountFormatted?: order_by | null
  reserveAmountRaw?: order_by | null
  timestamp?: order_by | null
  tokenAmountFormatted?: order_by | null
  tokenAmountRaw?: order_by | null
  tradeType?: order_by | null
  transactionHash?: order_by | null
  user_id?: order_by | null
}

/** order by min() on columns of table "Trade" */
export interface Trade_min_order_by {
  feeFormatted?: order_by | null
  feeRaw?: order_by | null
  id?: order_by | null
  market_id?: order_by | null
...
export interface Trade_stddev_order_by {
  feeRaw?: order_by | null
  newPriceRaw?: order_by | null
  reserveAmountRaw?: order_by | null
  timestamp?: order_by | null
...
export interface Trade_stddev_pop_order_by {
  feeRaw?: order_by | null
  newPriceRaw?: order_by | null
  reserveAmountRaw?: order_by | null
  timestamp?: order_by | null
...
export interface Trade_stddev_samp_order_by {
  feeRaw?: order_by | null
  newPriceRaw?: order_by | null
  reserveAmountRaw?: order_by | null
  timestamp?: order_by | null
...
/** Initial value of the column from where the streaming should start */
export interface Trade_stream_cursor_value_input {
  feeFormatted?: Scalars['String'] | null
  feeRaw?: Scalars['numeric'] | null
  id?: Scalars['String'] | null
  market_id?: Scalars['String'] | null
  newPriceFormatted?: Scalars['String'] | null
  newPriceRaw?: Scalars['numeric'] | null
  reserveAmountFormatted?: Scalars['String'] | null
  reserveAmountRaw?: Scalars['numeric'] | null
  timestamp?: Scalars['numeric'] | null
  tokenAmountFormatted?: Scalars['String'] | null
  tokenAmountRaw?: Scalars['numeric'] | null
  tradeType?: Scalars['tradetype'] | null
  transactionHash?: Scalars['String'] | null
  user_id?: Scalars['String'] | null
}

/** order by sum() on columns of table "Trade" */
export interface Trade_sum_order_by {
  feeRaw?: order_by | null
  newPriceRaw?: order_by | null
  reserveAmountRaw?: order_by | null
  timestamp?: order_by | null
...
export interface Trade_var_pop_order_by {
  feeRaw?: order_by | null
  newPriceRaw?: order_by | null
  reserveAmountRaw?: order_by | null
  timestamp?: order_by | null
...
export interface Trade_var_samp_order_by {
  feeRaw?: order_by | null
  newPriceRaw?: order_by | null
  reserveAmountRaw?: order_by | null
  timestamp?: order_by | null
...
export interface Trade_variance_order_by {
  feeRaw?: order_by | null
  newPriceRaw?: order_by | null
  reserveAmountRaw?: order_by | null
  timestamp?: order_by | null
...
export interface TreasuryGenqlSelection {
  createdAt?: boolean | number
  /** An array relationship */
  feeSplitterPayments?: FeeSplitterPaymentGenqlSelection & {
    __args?: {
      /** distinct select on columns */
  ...
  /** An array relationship */
  feeSplitterReceipts?: FeeSplitterReceiptGenqlSelection & {
    __args?: {
      /** distinct select on columns */
...
export interface Treasury_bool_exp {
  _and?: Treasury_bool_exp[] | null
  _not?: Treasury_bool_exp | null
  _or?: Treasury_bool_exp[] | null
  createdAt?: numeric_comparison_exp | null
  feeSplitterPayments?: FeeSplitterPayment_bool_exp | null
  feeSplitterReceipts?: FeeSplitterReceipt_bool_exp | null
  id?: String_comparison_exp | null
  lastUpdatedAt?: numeric_comparison_exp | null
  market_id?: String_comparison_exp | null
  totalFeesDistributedFormatted?: String_comparison_exp | null
  totalFeesDistributedRaw?: numeric_comparison_exp | null
  totalFeesReceivedFormatted?: String_comparison_exp | null
  totalFeesReceivedRaw?: numeric_comparison_exp | null
  treasuryAddress?: String_comparison_exp | null
}

/** Ordering options when selecting data from "Treasury". */
export interface Treasury_order_by {
  createdAt?: order_by | null
  feeSplitterPayments_aggregate?: FeeSplitterPayment_aggregate_order_by | null
  feeSplitterReceipts_aggregate?: FeeSplitterReceipt_aggregate_order_by | null
  id?: order_by | null
  lastUpdatedAt?: order_by | null
  market_id?: order_by | null
  totalFeesDistributedFormatted?: order_by | null
  totalFeesDistributedRaw?: order_by | null
  totalFeesReceivedFormatted?: order_by | null
  totalFeesReceivedRaw?: order_by | null
  treasuryAddress?: order_by | null
}
...
/** Initial value of the column from where the streaming should start */
export interface Treasury_stream_cursor_value_input {
  createdAt?: Scalars['numeric'] | null
  id?: Scalars['String'] | null
  lastUpdatedAt?: Scalars['numeric'] | null
  market_id?: Scalars['String'] | null
  totalFeesDistributedFormatted?: Scalars['String'] | null
  totalFeesDistributedRaw?: Scalars['numeric'] | null
  totalFeesReceivedFormatted?: Scalars['String'] | null
  totalFeesReceivedRaw?: Scalars['numeric'] | null
  treasuryAddress?: Scalars['String'] | null
}
...
export interface UserMarketPosition_aggregate_order_by {
  avg?: UserMarketPosition_avg_order_by | null
  count?: order_by | null
  max?: UserMarketPosition_max_order_by | null
  min?: UserMarketPosition_min_order_by | null
  stddev?: UserMarketPosition_stddev_order_by | null
  stddev_pop?: UserMarketPosition_stddev_pop_order_by | null
  stddev_samp?: UserMarketPosition_stddev_samp_order_by | null
  sum?: UserMarketPosition_sum_order_by | null
  var_pop?: UserMarketPosition_var_pop_order_by | null
  var_samp?: UserMarketPosition_var_samp_order_by | null
  variance?: UserMarketPosition_variance_order_by | null
}

/** order by avg() on columns of table "UserMarketPosition" */
export interface UserMarketPosition_avg_order_by {
  claimableRewardsRaw?: order_by | null
  lastUpdatedAt?: order_by | null
  lockedCollateralRaw?: order_by | null
  netFTokenChangeRaw?: order_by | null
  presaleDepositRaw?: order_by | null
  presaleLeverage?: order_by | null
  stakedAmountRaw?: order_by | null
  totalDebtRaw?: order_by | null
}

/** Boolean expression to filter rows from the table "UserMarketPosition". All fields are combined with a logical 'AND'. */
export interface UserMarketPosition_bool_exp {
  _and?: UserMarketPosition_bool_exp[] | null
  _not?: UserMarketPosition_bool_exp | null
  _or?: UserMarketPosition_bool_exp[] | null
  claimableRewardsFormatted?: String_comparison_exp | null
  claimableRewardsRaw?: numeric_comparison_exp | null
  id?: String_comparison_exp | null
  lastUpdatedAt?: numeric_comparison_exp | null
  lockedCollateralFormatted?: String_comparison_exp | null
  lockedCollateralRaw?: numeric_comparison_exp | null
  market_id?: String_comparison_exp | null
  netFTokenChangeFormatted?: String_comparison_exp | null
  netFTokenChangeRaw?: numeric_comparison_exp | null
  presaleDepositFormatted?: String_comparison_exp | null
  presaleDepositRaw?: numeric_comparison_exp | null
  presaleLeverage?: numeric_comparison_exp | null
  stakedAmountFormatted?: String_comparison_exp | null
  stakedAmountRaw?: numeric_comparison_exp | null
  totalDebtFormatted?: String_comparison_exp | null
  totalDebtRaw?: numeric_comparison_exp | null
  user_id?: String_comparison_exp | null
}
...
export interface UserMarketPosition_max_order_by {
  claimableRewardsFormatted?: order_by | null
  claimableRewardsRaw?: order_by | null
  id?: order_by | null
  lastUpdatedAt?: order_by | null
  lockedCollateralFormatted?: order_by | null
  lockedCollateralRaw?: order_by | null
  market_id?: order_by | null
  netFTokenChangeFormatted?: order_by | null
  netFTokenChangeRaw?: order_by | null
  presaleDepositFormatted?: order_by | null
  presaleDepositRaw?: order_by | null
  presaleLeverage?: order_by | null
  stakedAmountFormatted?: order_by | null
  stakedAmountRaw?: order_by | null
  totalDebtFormatted?: order_by | null
  totalDebtRaw?: order_by | null
  user_id?: order_by | null
...
export interface UserMarketPosition_min_order_by {
  claimableRewardsFormatted?: order_by | null
  claimableRewardsRaw?: order_by | null
  id?: order_by | null
  lastUpdatedAt?: order_by | null
...
export interface UserMarketPosition_order_by {
  claimableRewardsFormatted?: order_by | null
  claimableRewardsRaw?: order_by | null
  id?: order_by | null
  lastUpdatedAt?: order_by | null
...
export interface UserMarketPosition_stddev_order_by {
  claimableRewardsRaw?: order_by | null
  lastUpdatedAt?: order_by | null
  lockedCollateralRaw?: order_by | null
  netFTokenChangeRaw?: order_by | null
...
export interface UserMarketPosition_stream_cursor_value_input {
  claimableRewardsFormatted?: Scalars['String'] | null
  claimableRewardsRaw?: Scalars['numeric'] | null
  id?: Scalars['String'] | null
  lastUpdatedAt?: Scalars['numeric'] | null
  lockedCollateralFormatted?: Scalars['String'] | null
  lockedCollateralRaw?: Scalars['numeric'] | null
  market_id?: Scalars['String'] | null
  netFTokenChangeFormatted?: Scalars['String'] | null
  netFTokenChangeRaw?: Scalars['numeric'] | null
  presaleDepositFormatted?: Scalars['String'] | null
  presaleDepositRaw?: Scalars['numeric'] | null
  presaleLeverage?: Scalars['numeric'] | null
  stakedAmountFormatted?: Scalars['String'] | null
  stakedAmountRaw?: Scalars['numeric'] | null
  totalDebtFormatted?: Scalars['String'] | null
  totalDebtRaw?: Scalars['numeric'] | null
  user_id?: Scalars['String'] | null
}
...
export interface UserMarketPosition_sum_order_by {
  claimableRewardsRaw?: order_by | null
  lastUpdatedAt?: order_by | null
  lockedCollateralRaw?: order_by | null
  netFTokenChangeRaw?: order_by | null
...
export interface UserMarketPosition_var_pop_order_by {
  claimableRewardsRaw?: order_by | null
  lastUpdatedAt?: order_by | null
  lockedCollateralRaw?: order_by | null
  netFTokenChangeRaw?: order_by | null
...
export interface UserMarketPosition_var_samp_order_by {
  claimableRewardsRaw?: order_by | null
  lastUpdatedAt?: order_by | null
  lockedCollateralRaw?: order_by | null
  netFTokenChangeRaw?: order_by | null
...
export interface UserMarketPosition_variance_order_by {
  claimableRewardsRaw?: order_by | null
  lastUpdatedAt?: order_by | null
  lockedCollateralRaw?: order_by | null
  netFTokenChangeRaw?: order_by | null
...
export interface candleperiod_comparison_exp {
  _eq?: Scalars['candleperiod'] | null
  _gt?: Scalars['candleperiod'] | null
  _gte?: Scalars['candleperiod'] | null
  _in?: Scalars['candleperiod'][] | null
  _is_null?: Scalars['Boolean'] | null
  _lt?: Scalars['candleperiod'] | null
  _lte?: Scalars['candleperiod'] | null
  _neq?: Scalars['candleperiod'] | null
  _nin?: Scalars['candleperiod'][] | null
}
...
export interface loanstatus_comparison_exp {
  _eq?: Scalars['loanstatus'] | null
  _gt?: Scalars['loanstatus'] | null
  _gte?: Scalars['loanstatus'] | null
  _in?: Scalars['loanstatus'][] | null
  _is_null?: Scalars['Boolean'] | null
  _lt?: Scalars['loanstatus'] | null
  _lte?: Scalars['loanstatus'] | null
  _neq?: Scalars['loanstatus'] | null
  _nin?: Scalars['loanstatus'][] | null
}

/** Boolean expression to compare columns of type "marketstatus". All fields are combined with logical 'AND'. */
export interface marketstatus_comparison_exp {
  _eq?: Scalars['marketstatus'] | null
  _gt?: Scalars['marketstatus'] | null
  _gte?: Scalars['marketstatus'] | null
  _in?: Scalars['marketstatus'][] | null
  _is_null?: Scalars['Boolean'] | null
  _lt?: Scalars['marketstatus'] | null
  _lte?: Scalars['marketstatus'] | null
  _neq?: Scalars['marketstatus'] | null
  _nin?: Scalars['marketstatus'][] | null
}
...
export interface presaleclaimtype_comparison_exp {
  _eq?: Scalars['presaleclaimtype'] | null
  _gt?: Scalars['presaleclaimtype'] | null
  _gte?: Scalars['presaleclaimtype'] | null
  _in?: Scalars['presaleclaimtype'][] | null
  _is_null?: Scalars['Boolean'] | null
  _lt?: Scalars['presaleclaimtype'] | null
  _lte?: Scalars['presaleclaimtype'] | null
  _neq?: Scalars['presaleclaimtype'] | null
  _nin?: Scalars['presaleclaimtype'][] | null
}
...
export interface query_rootGenqlSelection {
  ...
  /** fetch data from the table: "AuthorizerContract" */
  AuthorizerContract?: AuthorizerContractGenqlSelection & {
    __args?: {
      /** distinct select on columns */
  ...
  /** fetch data from the table: "AuthorizerContract" using primary key columns */
  AuthorizerContract_by_pk?: AuthorizerContractGenqlSelection & {
    __args: { id: Scalars['String'] }
  }
  /** fetch data from the table: "CreditFacilityContract" */
  CreditFacilityContract?: CreditFacilityContractGenqlSelection & {
    __args?: {
      /** distinct select on columns */
  ...
  /** fetch data from the table: "CreditFacilityContract" using primary key columns */
  CreditFacilityContract_by_pk?: CreditFacilityContractGenqlSelection & {
    __args: { id: Scalars['String'] }
  }
  /** fetch data from the table: "FeeSplitterPayment" */
  FeeSplitterPayment?: FeeSplitterPaymentGenqlSelection & {
    __args?: {
      /** distinct select on columns */
      distinct_on?: FeeSplitterPayment_select_column[] | null
      /** limit the number of rows returned */
  ...
  /** fetch data from the table: "FeeSplitterPayment" using primary key columns */
  FeeSplitterPayment_by_pk?: FeeSplitterPaymentGenqlSelection & {
    __args: { id: Scalars['String'] }
  }
  /** fetch data from the table: "FeeSplitterReceipt" */
  FeeSplitterReceipt?: FeeSplitterReceiptGenqlSelection & {
    __args?: {
      /** distinct select on columns */
      distinct_on?: FeeSplitterReceipt_select_column[] | null
      /** limit the number of rows returned */
  ...
  /** fetch data from the table: "FeeSplitterReceipt" using primary key columns */
  FeeSplitterReceipt_by_pk?: FeeSplitterReceiptGenqlSelection & {
    __args: { id: Scalars['String'] }
  }
  /** fetch data from the table: "FloorElevation" */
  FloorElevation?: FloorElevationGenqlSelection & {
    __args?: {
      /** distinct select on columns */
      distinct_on?: FloorElevation_select_column[] | null
      /** limit the number of rows returned */
  ...
  /** fetch data from the table: "GlobalRegistry" */
  GlobalRegistry?: GlobalRegistryGenqlSelection & {
    __args?: {
      /** distinct select on columns */
  ...
  /** fetch data from the table: "GlobalStats" */
  GlobalStats?: GlobalStatsGenqlSelection & {
    __args?: {
      /** distinct select on columns */
  ...
  /** fetch data from the table: "GlobalStatsSnapshot" */
  GlobalStatsSnapshot?: GlobalStatsSnapshotGenqlSelection & {
    __args?: {
      /** distinct select on columns */
  ...
  /** fetch data from the table: "GlobalStatsSnapshot" using primary key columns */
  GlobalStatsSnapshot_by_pk?: GlobalStatsSnapshotGenqlSelection & {
    __args: { id: Scalars['String'] }
  }
  /** fetch data from the table: "GlobalStats" using primary key columns */
  GlobalStats_by_pk?: GlobalStatsGenqlSelection & { __args: { id: Scalars['String'] } }
  /** fetch data from the table: "Loan" */
  Loan?: LoanGenqlSelection & {
    __args?: {
      /** distinct select on columns */
      distinct_on?: Loan_select_column[] | null
      /** limit the number of rows returned */
  ...
  /** fetch data from the table: "LoanStatusHistory" */
  LoanStatusHistory?: LoanStatusHistoryGenqlSelection & {
    __args?: {
      /** distinct select on columns */
      distinct_on?: LoanStatusHistory_select_column[] | null
      /** limit the number of rows returned */
  ...
  /** fetch data from the table: "MarketRollingStats" */
  MarketRollingStats?: MarketRollingStatsGenqlSelection & {
    __args?: {
      /** distinct select on columns */
  ...
  /** fetch data from the table: "MarketRollingStats" using primary key columns */
  MarketRollingStats_by_pk?: MarketRollingStatsGenqlSelection & {
    __args: { id: Scalars['String'] }
  }
  /** fetch data from the table: "MarketSnapshot" */
  MarketSnapshot?: MarketSnapshotGenqlSelection & {
    __args?: {
      /** distinct select on columns */
  ...
  /** fetch data from the table: "ModuleAddress" */
  ModuleAddress?: ModuleAddressGenqlSelection & {
    __args?: {
      /** distinct select on columns */
  ...
  /** fetch data from the table: "ModuleRegistry" */
  ModuleRegistry?: ModuleRegistryGenqlSelection & {
    __args?: {
      /** distinct select on columns */
  ...
  /** fetch data from the table: "PreSaleContract" */
  PreSaleContract?: PreSaleContractGenqlSelection & {
    __args?: {
      /** distinct select on columns */
  ...
  /** fetch data from the table: "PresaleClaim" */
  PresaleClaim?: PresaleClaimGenqlSelection & {
    __args?: {
      /** distinct select on columns */
      distinct_on?: PresaleClaim_select_column[] | null
      /** limit the number of rows returned */
  ...
  /** fetch data from the table: "PresaleParticipation" */
  PresaleParticipation?: PresaleParticipationGenqlSelection & {
    __args?: {
      /** distinct select on columns */
      distinct_on?: PresaleParticipation_select_column[] | null
      /** limit the number of rows returned */
  ...
  /** fetch data from the table: "PresaleParticipation" using primary key columns */
  PresaleParticipation_by_pk?: PresaleParticipationGenqlSelection & {
    __args: { id: Scalars['String'] }
  }
  /** fetch data from the table: "PriceCandle" */
  PriceCandle?: PriceCandleGenqlSelection & {
    __args?: {
      /** distinct select on columns */
  ...
  /** fetch data from the table: "RoleMember" */
  RoleMember?: RoleMemberGenqlSelection & {
    __args?: {
      /** distinct select on columns */
      distinct_on?: RoleMember_select_column[] | null
      /** limit the number of rows returned */
  ...
  /** fetch data from the table: "RolePermission" */
  RolePermission?: RolePermissionGenqlSelection & {
    __args?: {
      /** distinct select on columns */
      distinct_on?: RolePermission_select_column[] | null
      /** limit the number of rows returned */
  ...
  /** fetch data from the table: "StakePosition" */
  StakePosition?: StakePositionGenqlSelection & {
    __args?: {
      /** distinct select on columns */
      distinct_on?: StakePosition_select_column[] | null
      /** limit the number of rows returned */
  ...
  /** fetch data from the table: "StakingActivity" */
  StakingActivity?: StakingActivityGenqlSelection & {
    __args?: {
      /** distinct select on columns */
      distinct_on?: StakingActivity_select_column[] | null
      /** limit the number of rows returned */
  ...
  /** fetch data from the table: "StakingManager" */
  StakingManager?: StakingManagerGenqlSelection & {
    __args?: {
      /** distinct select on columns */
  ...
  /** fetch data from the table: "Strategy" */
  Strategy?: StrategyGenqlSelection & {
    __args?: {
      /** distinct select on columns */
      distinct_on?: Strategy_select_column[] | null
      /** limit the number of rows returned */
  ...
  /** fetch data from the table: "Treasury" */
  Treasury?: TreasuryGenqlSelection & {
    __args?: {
      /** distinct select on columns */
  ...
  /** fetch data from the table: "UserMarketPosition" */
  UserMarketPosition?: UserMarketPositionGenqlSelection & {
    __args?: {
      /** distinct select on columns */
      distinct_on?: UserMarketPosition_select_column[] | null
      /** limit the number of rows returned */
  ...
  /** fetch data from the table: "UserMarketPosition" using primary key columns */
  UserMarketPosition_by_pk?: UserMarketPositionGenqlSelection & {
    __args: { id: Scalars['String'] }
  }
  /** fetch data from the table: "_meta" */
...
export interface snapshotperiod_comparison_exp {
  _eq?: Scalars['snapshotperiod'] | null
  _gt?: Scalars['snapshotperiod'] | null
  _gte?: Scalars['snapshotperiod'] | null
  _in?: Scalars['snapshotperiod'][] | null
  _is_null?: Scalars['Boolean'] | null
  _lt?: Scalars['snapshotperiod'] | null
  _lte?: Scalars['snapshotperiod'] | null
  _neq?: Scalars['snapshotperiod'] | null
  _nin?: Scalars['snapshotperiod'][] | null
}

/** Boolean expression to compare columns of type "stakepositionstatus". All fields are combined with logical 'AND'. */
export interface stakepositionstatus_comparison_exp {
  _eq?: Scalars['stakepositionstatus'] | null
  _gt?: Scalars['stakepositionstatus'] | null
  _gte?: Scalars['stakepositionstatus'] | null
  _in?: Scalars['stakepositionstatus'][] | null
  _is_null?: Scalars['Boolean'] | null
  _lt?: Scalars['stakepositionstatus'] | null
  _lte?: Scalars['stakepositionstatus'] | null
  _neq?: Scalars['stakepositionstatus'] | null
  _nin?: Scalars['stakepositionstatus'][] | null
}
...
export interface stakingactivitytype_comparison_exp {
  _eq?: Scalars['stakingactivitytype'] | null
  _gt?: Scalars['stakingactivitytype'] | null
  _gte?: Scalars['stakingactivitytype'] | null
  _in?: Scalars['stakingactivitytype'][] | null
  _is_null?: Scalars['Boolean'] | null
  _lt?: Scalars['stakingactivitytype'] | null
  _lte?: Scalars['stakingactivitytype'] | null
  _neq?: Scalars['stakingactivitytype'] | null
  _nin?: Scalars['stakingactivitytype'][] | null
}
...
export interface subscription_rootGenqlSelection {
  ...
  Account_by_pk?: AccountGenqlSelection & { __args: { id: Scalars['String'] } }
  /** fetch data from the table in a streaming manner: "Account" */
  Account_stream?: AccountGenqlSelection & {
    __args: {
  ...
  /** fetch data from the table in a streaming manner: "AuthorizerContract" */
  AuthorizerContract_stream?: AuthorizerContractGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  /** fetch data from the table in a streaming manner: "CreditFacilityContract" */
  CreditFacilityContract_stream?: CreditFacilityContractGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  /** fetch data from the table in a streaming manner: "FeeSplitterPayment" */
  FeeSplitterPayment_stream?: FeeSplitterPaymentGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  /** fetch data from the table in a streaming manner: "FeeSplitterReceipt" */
  FeeSplitterReceipt_stream?: FeeSplitterReceiptGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  FloorElevation_by_pk?: FloorElevationGenqlSelection & { __args: { id: Scalars['String'] } }
  /** fetch data from the table in a streaming manner: "FloorElevation" */
  FloorElevation_stream?: FloorElevationGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  GlobalRegistry_by_pk?: GlobalRegistryGenqlSelection & { __args: { id: Scalars['String'] } }
  /** fetch data from the table in a streaming manner: "GlobalRegistry" */
  GlobalRegistry_stream?: GlobalRegistryGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  /** fetch data from the table in a streaming manner: "GlobalStatsSnapshot" */
  GlobalStatsSnapshot_stream?: GlobalStatsSnapshotGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  GlobalStats_by_pk?: GlobalStatsGenqlSelection & { __args: { id: Scalars['String'] } }
  /** fetch data from the table in a streaming manner: "GlobalStats" */
  GlobalStats_stream?: GlobalStatsGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  LoanStatusHistory_by_pk?: LoanStatusHistoryGenqlSelection & { __args: { id: Scalars['String'] } }
  /** fetch data from the table in a streaming manner: "LoanStatusHistory" */
  LoanStatusHistory_stream?: LoanStatusHistoryGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  Loan_by_pk?: LoanGenqlSelection & { __args: { id: Scalars['String'] } }
  /** fetch data from the table in a streaming manner: "Loan" */
  Loan_stream?: LoanGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  /** fetch data from the table in a streaming manner: "MarketRollingStats" */
  MarketRollingStats_stream?: MarketRollingStatsGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  MarketSnapshot_by_pk?: MarketSnapshotGenqlSelection & { __args: { id: Scalars['String'] } }
  /** fetch data from the table in a streaming manner: "MarketSnapshot" */
  MarketSnapshot_stream?: MarketSnapshotGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  Market_by_pk?: MarketGenqlSelection & { __args: { id: Scalars['String'] } }
  /** fetch data from the table in a streaming manner: "Market" */
  Market_stream?: MarketGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  ModuleAddress_by_pk?: ModuleAddressGenqlSelection & { __args: { id: Scalars['String'] } }
  /** fetch data from the table in a streaming manner: "ModuleAddress" */
  ModuleAddress_stream?: ModuleAddressGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  ModuleRegistry_by_pk?: ModuleRegistryGenqlSelection & { __args: { id: Scalars['String'] } }
  /** fetch data from the table in a streaming manner: "ModuleRegistry" */
  ModuleRegistry_stream?: ModuleRegistryGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  PreSaleContract_by_pk?: PreSaleContractGenqlSelection & { __args: { id: Scalars['String'] } }
  /** fetch data from the table in a streaming manner: "PreSaleContract" */
  PreSaleContract_stream?: PreSaleContractGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  PresaleClaim_by_pk?: PresaleClaimGenqlSelection & { __args: { id: Scalars['String'] } }
  /** fetch data from the table in a streaming manner: "PresaleClaim" */
  PresaleClaim_stream?: PresaleClaimGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  /** fetch data from the table in a streaming manner: "PresaleParticipation" */
  PresaleParticipation_stream?: PresaleParticipationGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  PriceCandle_by_pk?: PriceCandleGenqlSelection & { __args: { id: Scalars['String'] } }
  /** fetch data from the table in a streaming manner: "PriceCandle" */
  PriceCandle_stream?: PriceCandleGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  RoleMember_by_pk?: RoleMemberGenqlSelection & { __args: { id: Scalars['String'] } }
  /** fetch data from the table in a streaming manner: "RoleMember" */
  RoleMember_stream?: RoleMemberGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  RolePermission_by_pk?: RolePermissionGenqlSelection & { __args: { id: Scalars['String'] } }
  /** fetch data from the table in a streaming manner: "RolePermission" */
  RolePermission_stream?: RolePermissionGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  StakePosition_by_pk?: StakePositionGenqlSelection & { __args: { id: Scalars['String'] } }
  /** fetch data from the table in a streaming manner: "StakePosition" */
  StakePosition_stream?: StakePositionGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  StakingActivity_by_pk?: StakingActivityGenqlSelection & { __args: { id: Scalars['String'] } }
  /** fetch data from the table in a streaming manner: "StakingActivity" */
  StakingActivity_stream?: StakingActivityGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  StakingManager_by_pk?: StakingManagerGenqlSelection & { __args: { id: Scalars['String'] } }
  /** fetch data from the table in a streaming manner: "StakingManager" */
  StakingManager_stream?: StakingManagerGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  Strategy_by_pk?: StrategyGenqlSelection & { __args: { id: Scalars['String'] } }
  /** fetch data from the table in a streaming manner: "Strategy" */
  Strategy_stream?: StrategyGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  Trade_by_pk?: TradeGenqlSelection & { __args: { id: Scalars['String'] } }
  /** fetch data from the table in a streaming manner: "Trade" */
  Trade_stream?: TradeGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  Treasury_by_pk?: TreasuryGenqlSelection & { __args: { id: Scalars['String'] } }
  /** fetch data from the table in a streaming manner: "Treasury" */
  Treasury_stream?: TreasuryGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
  ...
  /** fetch data from the table in a streaming manner: "UserMarketPosition" */
  UserMarketPosition_stream?: UserMarketPositionGenqlSelection & {
    __args: {
      /** maximum number of rows returned in a single batch */
      batch_size: Scalars['Int']
      /** cursor to stream the results returned by the query */
...
export interface tradetype_comparison_exp {
  _eq?: Scalars['tradetype'] | null
  _gt?: Scalars['tradetype'] | null
  _gte?: Scalars['tradetype'] | null
  _in?: Scalars['tradetype'][] | null
  _is_null?: Scalars['Boolean'] | null
  _lt?: Scalars['tradetype'] | null
  _lte?: Scalars['tradetype'] | null
  _neq?: Scalars['tradetype'] | null
  _nin?: Scalars['tradetype'][] | null
}
...
export const isAuthorizerContract = (
  obj?: { __typename?: any } | null
): obj is AuthorizerContract => {
...
export const isCreditFacilityContract = (
  obj?: { __typename?: any } | null
): obj is CreditFacilityContract => {
...
export const isFeeSplitterPayment = (
  obj?: { __typename?: any } | null
): obj is FeeSplitterPayment => {
...
export const isFeeSplitterReceipt = (
  obj?: { __typename?: any } | null
): obj is FeeSplitterReceipt => {
...
export const isGlobalStatsSnapshot = (
  obj?: { __typename?: any } | null
): obj is GlobalStatsSnapshot => {
...
export const isLoanStatusHistory = (
  obj?: { __typename?: any } | null
): obj is LoanStatusHistory => {
...
export const isMarketRollingStats = (
  obj?: { __typename?: any } | null
): obj is MarketRollingStats => {
...
export const isPresaleParticipation = (
  obj?: { __typename?: any } | null
): obj is PresaleParticipation => {
...
export const isUserMarketPosition = (
  obj?: { __typename?: any } | null
): obj is UserMarketPosition => {
